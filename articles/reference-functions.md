...
|Examples|<ol><li>Add an input-text control, and name it **Source**.</li><li>Add a label, and set its **Text** property to this expression:<br>**Abs(Value(Source!Text))** returns 55.<br><br>If a table contained a column named **Trend**, you could use **Abs(Trend)** in a **Result** column to show the absolute value of each number in the **Trend** column.<br/><br/>![Abs function to calculate absolute values](./media/reference-functions/abs.jpg)|
...
|Example|<ol><li>Name the default screen **Source**, add another screen, and name it **Target**.</li><li>On the **Source** screen, add a dropdown list, and name it **Numbers**.</li><li>Add a button, and set its **OnSelect** property to this expression:<br>**Navigate(Target, ScreenTransition!None, {Choice:Numbers!Selected!Value})**</li><li>On the **Target** screen, add a label, and set its **Text** property to **Choice**.</li><li>Add a button, and set its **OnSelect** property to this expression:<br>**Navigate(Target, ScreenTransition!None)**</li><li>On the **Source** screen, press F5, click an option in the list, and then click the button to show the **Target** screen.<br>The label on the **Target** screen shows the number that you chose.</li><li>Click the button to return to the **Source** screen, click a different option in the list, and then click the button to return to the **Target** screen.<br>The label on the **Target** screen shows the second number that you chose.</li></ol>[Another example](add-screen-context-variable.md)|
