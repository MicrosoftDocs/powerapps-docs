...
- See the [PowerApps Pricing](https://powerapps.microsoft.com/en-us/pricing/) page for details about custom API creation quotas. Custom APIs that are shared with you don't count against this quota.
