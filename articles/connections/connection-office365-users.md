...
2. In the function bar, set the **[Text](../properties/properties-core.md)** property to any of the following formulas:  
...
2. In the function bar, set the gallery's **[Items](../properties/properties-core.md)** property to any of the following formulas:  
...
3. In the function bar, set the gallery's **[Items](../properties/properties-core.md)** property to the following formula:  
...
4. In the function bar, set the gallery's **[Items](../properties/properties-core.md)** property to the following formula:  
