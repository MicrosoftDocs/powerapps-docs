...
1. In the right-hand pane, click or tap on the **Data** tab and then click or tap on **Add data source**.

	**Note**: If you're updating an existing app and **Add data source** doesn't appear in the right-hand pane, click or tap on **Data sources** in the **View** ribbon menu.
