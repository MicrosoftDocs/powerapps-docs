...
1. Add a **[Text box](controls/control-text-box.md)** control to the screen.
	...
	When you add a text box, the property list automatically shows the **[Text](properties/properties-core.md)** property, which drives what the control shows. By default, the value of this property is **"Text"**.  

1. Set the value of the **[Text](properties/properties-core.md)** property to **"Hello World"** by typing that string, surrounded by double quotes, into the formula bar:
...
1. In the **[Text](properties/properties-core.md)** property of the text box, replace **"Hello World"** with **Sum(1,2,3)**.
...
Regardless of what numbers you type in the input-text controls, the text box always shows the sum of those numbers because its **[Text](properties/properties-core.md)** property is set to this formula:
...
1. Set the **[Color](properties/properties-color-border.md)** property of the text box to this formula:<br>**If( Value(TextBox1.Text) < 0, Red, Black )**

	**Note:** In a formula, specify the property of a control by providing the name of the control, followed by a period, followed by the name of the property. For example, specify the **[Text](properties/properties-core.md)** property of **TextBox1** by typing **TextBox1.Text**.
...
## Manage app behavior ##
You can use formulas not only to perform calculations and change appearance but also to take action. For example, you can set the **[OnSelect](properties/properties-core.md)** property of a button to a formula that includes the **[Navigate](functions/function-navigate.md)** function. When a user selects that button, the screen that you specify in the formula appears.
