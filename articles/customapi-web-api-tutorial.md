...
This tutorial shows you how to create an ASP.NET Web API, host it on Azure Web Apps, enable AAD authentication, and then register the ASP.NET Web API in PowerApps and Microsoft Flow.  
