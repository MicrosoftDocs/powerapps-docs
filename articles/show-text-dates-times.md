...
Show text in a **Text box** control by setting the value of its **Text** property. Set this property by typing directly into the control or by typing an expression in the formula bar.
...
1. Add a **Text input** control named **BirthDate**, and move it under **ShowText**.
...
<br>**DateDiff(Today(), DateValue(BirthDate.Text))**
	...
	**ShowText** shows the number of days between today and whatever date you type into **BirthDate**. When you type a date into **BirthDate**, its **Text** property is automatically set to that value. If your birthday has already occurred this year, a negative value appears in **ShowText**.
...
> [AZURE.NOTE] The **DateTimeValue** and **DateValue** functions can convert dates in any of these formats into values:  
> - MM/DD/YYYY  
> - DD/MM/YYYY  
> - DD Mon YYYY  
> - Month DD, YYYY  
...
1. Add a **Text box** control named **ShowDate**, and set its **Text** property to this formula:
...
1. Change the **Text** property of **ShowDate** to this formula:
...
1. To use one of several built-in formats, change the **Text** property of **ShowDate** to this formula:
...
1. To use a custom format, change the **Text** property of **ShowDate** to this formula:
...
1. Add a **Text box** control named **FormatDate**, and set its **Text** property to this formula:
<br>**DateValue(ArrivalDate.Text)**

	**FormatDate** shows the date that you typed, except the year appears as four digits.

1. Set the **Text** property of **FormatDate** to this formula:
<br>**DateValue(ArrivalDate.Text, "fr")**

	**FormatDate** shows the day before the month, just as a French user would expect.

1. To use one of several built-in formats, set the **Text** property of **FormatDate** to this formula:
...
1. Add a **Text box** control named **ShowTime**.

1. To use one of several built-in formats, set the **Text** property of **ShowTime** to this formula:
...
1. To use a custom format, set the **Text** property of **ShowTime** to this formula:
...
1. Add a **Text box** control named **DateDiff**, and set its **Text** property to this formula:
...
1. Set the **Text** property of **DateDiff** to this formula:  <br>**DateDiff(DateValue(Start.Text), DateValue(End.Text), Months)**
...
1. Add a **Text box** control named **DateAdd**, and set its **Text** property to this formula:
...
1. Set the **Text** property of **DateAdd** to this formula:
<br>**DateAdd(DateValue(Start.Text), -3)**
...
1. Change the **Text** property of **DateAdd** to this formula:
