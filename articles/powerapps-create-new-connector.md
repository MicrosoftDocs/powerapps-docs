...
<properties
	...
	description="IT Pro doc: Add, create, and configure a new API, connection or connection profile, and give permissions and rights with user access in the Azure portal"
	services="power-apps"
	documentationCenter="" 
