<properties
	pageTitle="Enable and Disable functions | Microsoft PowerApps"
...
These functions have no return value. You can use them only in [behavior formulas](../working-with-formulas-in-depth.md#behavior-formulas).
