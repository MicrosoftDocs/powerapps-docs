...
|---------|-------------|--------|
| **Update(&nbsp;IceCream,<br>First(&nbsp;Filter(&nbsp;IceCream, Flavor="Chocolate"&nbsp;)&nbsp;),<br>{&nbsp;ID:&nbsp;1, Flavor:&nbsp;"Mint&nbsp;Chocolate", Quantity:150&nbsp;} )** | Replaces a record from the data source.| <style> img { max-width:none; } </style> ![](media/function-update-updateif/icecream-mint.png)<br><br>The **IceCream** data source has been modified. |
