...
Let's say that you had a [data source](working-with-data-sources.md) named **Sales** that contained a **CostPerUnit** column and a **UnitsSold** column, and you set the **[Text](../properties/properties-core.md)** property of a label to this function:<br>
...
As a different example, let's say that you had sliders that were named **Slider1**, **Slider2**, and **Slider3** and a label with its **[Text](../properties/properties-core.md)** property set to this formula:<br>
