...
1. **New sample apps and templates**.
	...
	You can open a sample app that demonstrates a scenario such as showcasing products, surveying employee engagement, and checking out assets, and helping a new employee choose a health plan.
