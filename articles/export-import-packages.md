...
When an app is ready to release to the larger organization, you need to move it and its resources to a different environment. For more information, see [this topic](environment-and-tenant-migration.md).
