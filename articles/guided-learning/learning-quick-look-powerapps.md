...
Now that you know the basics of PowerApps, let's jump into **a tour of how to create apps**. We'll quickly look at sample apps, creating apps from a template, using shared apps, and creating apps from a data source. In the next topic, we will get more hands-on with app creation.
