...
| HTML Text   | Specify the text that appears in an HTML text box, including markup that you want the control to render. |
...
| Text        | Specify the text that appears in a text box, next to a checkbox, or on a button, an export control, an import control, or a SharePoint Update control. |
...
| OnSelect     | Specifies how your app responds when, for example, a user clicks a button, a text box, an image, or any other control for which you've set this property. |
...
| Property | Description |
|----------|-------------|
| Align                 | Specify **Align.Left**, **Align.Center**, **Align.Right**, or **Align.Justified** to change the alignment of text on a button or in a text box, an input-text control, or another type of control. |
...
| Color                 | Specify RGBA values or click an option to change the color of the text in a text box, a button, or other control or the color of the input in a pen control. For example, you can specify **RGBA(192, 0, 0, 1)** to make the text or input red. |
...
| Font                  | Specify the name of the font that you want to use for the text in a text box, an input-text control, a listbox, or another control. |
...
| Italic                | Specify **true** to italicize the text in a text box, input-text control, a button, or another control. Otherwise, specify **false**. |
...
| Line Height           | Specify a number that represents the amount of space between, for example, lines in a text box, items in a listbox, or lines in an input-text control for which the **Mode** property is set to Multiline. |
...
| Overflow              | Specify **Overflow.Scroll** to show a vertical scrollbar when a text box is too small to show all of the text it contains, or specify **Overflow.Hidden** to hide that scrollbar. |
