...
**[Card](controls/control-card.md)** – Display and edit an individual field of a record in a **[Form](controls/control-form-detail.md)** or **[View form](controls/control-form-detail.md)** control.
...
**[Icons](controls/control-shapes-icons.md)** – Add graphic appeal and visual interest.
...
**[Radio buttons](controls/control-radio.md)** – Show options that are mutually exclusive.
...
**[Shapes](controls/control-shapes-icons.md)** – Display arrows and geometric shapes, such as rectangles.
...
**[Color and border](proeprties/properties-color-border.md)** – Configure the color and border of a control that can change as a user interacts with it.
