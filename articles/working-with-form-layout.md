...
1. In the gallery, click or tap **SO004**.
...
1. (optional) Format the label as follows:

	1. Set its **Align** property to **Center**.
	1. Set its **Size** property to **20**.
	1. Set its **Fill** property to **Navy**.
	1. Set its **Color** property to **White**.
	1. Set its **Width** property to **Parent.Width**.
	1. Set its **X** and **Y** properties to **0**.
...
5. Resize the **Name** and **Description** cards to take up six columns (or 1/2) of the form.
...
1. Select the **Second line of Delivery address** card, select the label within that card, and then delete all of the text in it.
...
1. In the same card, move the text input box over the label to reduce the space between the first and second lines of the address.
