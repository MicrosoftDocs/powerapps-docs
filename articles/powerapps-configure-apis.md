...
View and modify the policy of your API:
...
This policy is the same policy supported by [Azure API Management](https://azure.microsoft.com/services/api-management). The current policy is in the embedded XML editor. You can either edit inline or upload a new XML file. After you **Save** your changes, any errors are shows in this blade, including any issues with the API policy.
