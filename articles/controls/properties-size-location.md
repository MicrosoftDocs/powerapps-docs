...
**X** – The distance between the left edge of a control and the left edge of its parent container (screen if no parent container).  For a **[Card](controls/control-card.md)** determines the column of the card within the container control.
...
**Y** – The distance between the top edge of a control and the top edge of the parent container (screen if no parent container).  For a **[Card](controls/control-card.md)** determines the row of the card within the container control.
