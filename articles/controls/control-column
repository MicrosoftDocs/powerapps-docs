<properties
	pageTitle="Column control: reference | Microsoft PowerApps"
...
6. In the list of entities, click or tap **Account**, and then click or tap **Connect**.

	The **Data table** control is initialized and shows a set of default fields.

7. Click or tap the **Full name** column.
