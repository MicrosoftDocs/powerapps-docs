...
## Example ##
1. Add a button, and set its **Text** property to show **Collect**.
...
1. Add a text gallery in vertical/portrait orientation, and set its **Items** property to this formula:

	**Filter(CityPopulations, Countries.Selected.Value in Country)**

1. In the first item of the gallery, set the **Text** property of the upper text box to **ThisItem.City**, delete the bottom text box, and set the **TemplateSize** property to **80**.

1. Press F5, select the chevron in the **Countries** list, and then select an option in that list.

	The gallery shows only those cities in the country that you selected.
