...
1. Add a **[Button](control-button.md)** control, move it below **MyDoodles**, and set the **[Text](../properties/properties-core.md)** property of the **[Button](control-button.md)** control to show **Add**.

1. Set the **[OnSelect](../properties/properties-core.md)** property of the **[Button](control-button.md)** control to this formula:<br>
...
1. Set the **[Items](../properties/properties-core.md)** property of the **Image gallery** control to **Doodles**, and then  press F5.
...
1. In the **Image gallery** control, set the **[OnSelect](../properties/properties-core.md)** property of the **[Image](control-image.md)** control to this formula:<br>
