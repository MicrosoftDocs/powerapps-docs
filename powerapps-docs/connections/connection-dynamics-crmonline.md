...
By following the steps in this topic, you'll create an app in which users can browse, add, delete, and make updates to contacts in Dynamics 365. Users can run the app [in a browser](../maker/run-app-browser.md) or [on a mobile device](../run-app-client.md) such as a phone.
