...
3. Added accessibility enhancements to [multimedia](maker/add-images-pictures-audio-video.md) controls.
...
4. Control the size of the local record limit store up to a maximum of 2000 records in [non-delegable queries](maker/delegation-overview.md#non-delegable-limits). (Experimental feature)
...
3. [Customize SharePoint list forms](maker/customize-list-form.md) using PowerApps.
