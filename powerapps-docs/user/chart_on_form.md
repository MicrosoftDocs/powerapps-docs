...
Use the **More Commands** button ![More commands button](media/commandbar_more_button_charts.png "More commands button")   to access commands such as, create a new chart, import, export, and more. The chart commands options are different for system charts and personal charts.
