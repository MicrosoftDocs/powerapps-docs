...
You don't need to manually work on a task to get your work done. By using Power Apps, you can create and use a canvas app or model-driven app to get your work done quickly. When you create an app, you can share the app with your organization. 

[Canvas apps](../maker/canvas-apps/getting-started.md) give you much control over the user experience of the app. An app maker can use templates to create a canvas app, or they can configure the app any way they like. A canvas app, like its name, is a blank canvas, so you can create an app to fit the needs of users in your organization.

Because canvas apps can essentially be anything, there isn't much help documentation on how to use an app once it's created. If you need help with using a canvas app, contact your app maker or Power Apps admin.
...
Additionally, you need a Power Apps license to run an app. If you don't have a license, you can request one by following instructions in this article: [Request a Power Apps license](request-license.md).
