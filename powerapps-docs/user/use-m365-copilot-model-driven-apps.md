...
If Microsoft 365 Copilot chat and [Copilot chat in model-driven apps](use-copilot-model-driven-apps.md) are both enabled, you will have the option to try both. The **Chat** option represents Microsoft 365 Copilot and the **App Skills** option represents [Copilot chat in model-driven apps](use-copilot-model-driven-apps.md).  These terms are used to align with Microsoft 365 apps for consistency.
...
- [Customize Microsoft 365 Copilot chat in model-driven apps](../maker/model-driven-apps/m365-customize-copilot-chat.md)
