...
|Reflows from *left to right*: Reflow experience from multiple columns to one column   |Reflows from *top to bottom*: Reflow experience when control spans at least two columns in a section (notice column #5 spans across) |
|---------|---------|
