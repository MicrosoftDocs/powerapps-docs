...
> [!IMPORTANT]
> With the October monthly channel release rolling out on build 2410.1, the **New Look** toggle as been removed and users will have it be always on. Learn more at [Managing always on rollout](#managing-always-on-rollout). This change was shared in [2024 wave 2 release note](https://learn.microsoft.com/en-us/power-platform/release-plan/2024wave2/power-apps/use-modern-refreshed-look-model-driven-apps) and [October 2024 monthly release note](https://learn.microsoft.com/en-us/power-platform/released-versions/common-data-service/monthly-2410#new-look-always-on).
