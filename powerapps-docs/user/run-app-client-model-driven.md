...
After the app is created and then shared with you, you can run that app on a variety of popular mobile devices such as Windows, iOS, Android, or in a web browser on an iOS or Android tablet. In this topic, you'll learn how to run a model-driven app on a mobile device. 
