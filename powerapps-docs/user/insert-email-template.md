...
> [!Note] 
> - The enhanced email template selection dialog is enabled out-of-the box in Dynamics 365 Customer Service. The enhanced email template selection dialog is the default template selection dialog only in the Customer Service workspace and Customer Service Hub apps.
