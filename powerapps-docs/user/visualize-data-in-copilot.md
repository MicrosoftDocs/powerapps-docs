...
:::image type="content" source="visualize-data-button.png" alt-text="Screenshot that shows Visualize button on the page.":::
...
:::image type="content" source="visualize-data-chart.png" alt-text="Screenshot showing data visualization in the form of a chart on the page.":::
...
:::image type="content" source="visualize-data-chart-detail-annotations.png" alt-text="Screenshot showing detailed options present in the chart.":::
...
[Responsible AI FAQ about Copilot visualizations on a view](#prerequisites) 