...
|![Undo Typing.](media/personalization.png "Undo Typing")| User personalization | | Select the default Font Name and Font Size. Once added, the **Font** and **Font Size** reflect these values as default font and font size. | 
