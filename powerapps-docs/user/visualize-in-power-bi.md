...
Create reports in the Power BI service using the data that in a view of your model-driven app. Power BI automatically generates the visuals for you, so you can explore the data with just a few clicks.
