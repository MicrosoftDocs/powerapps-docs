...
> [!IMPORTANT]
> To ensure proper functionality of all views, it is recommended to create all views with the View designer in their maker portal or the Edit filters panel in the view page. Custom views imported from solutions may include invalid fetchXML and may not be supported.
