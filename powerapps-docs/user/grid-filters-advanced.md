...
Easily create a personal view for yourself to see the records that are important to you. The advanced filter options lets you to create a wide range of views from simple to complex that you can also add group and nested conditions to.
