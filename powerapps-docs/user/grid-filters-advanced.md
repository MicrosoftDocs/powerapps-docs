...
For more information on views in model-driven apps see [Understand model-driven app views](powerapps/maker/model-driven-apps/create-edit-views)
...
| **Share** | <ul> <li>Share the view with other members of your organization by selecting the team/user to share it with and defining permissions. For more information, see [Share rows with a user or team](powerapps/user/share-row) </li> <li> Appears only on personal views for which you have share permission. </li></ul>|
