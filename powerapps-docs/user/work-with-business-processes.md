...
For more information on to how to apply business logic in Common Data Service, see [Apply business logic in Common Data Service](https://docs.microsoft.com/powerapps/maker/common-data-service/cds-processes).
