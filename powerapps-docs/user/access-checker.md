...
:::image type="content" source="media/check-access-1.png" alt-text="Check access results.":::
...
:::image type="content" source="media/check-access-2.png" alt-text="Check access results.":::
