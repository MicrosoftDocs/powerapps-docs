...
:::image type="content" source="media/check-access-results-1.png" alt-text="Check access results.":::
...
:::image type="content" source="media/check-access-results-2.png" alt-text="Check access results.":::
