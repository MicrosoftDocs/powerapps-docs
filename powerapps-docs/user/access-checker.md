...
For more information on how privileges and access check works, see [How access to a record is determined](https://docs.microsoft.com/power-platform/admin/how-record-access-determined).
