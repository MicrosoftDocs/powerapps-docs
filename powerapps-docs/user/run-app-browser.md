...
- In the case of model-driven apps, changes made only to the icon may not be reflected. Until this issue is resolved, changing another property like description will cause the icon to be updated.
