...
4. You can set the default font and font size for your emails using **User Personalization** ![Send email icon.](media\personalization.png "personalization icon"). Once set, the **Font** and **Font Size** display these values by default. 
