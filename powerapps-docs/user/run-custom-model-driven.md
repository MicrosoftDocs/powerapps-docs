---
title: Run a Dynamics 365 model-driven app on a mobile device | Microsoft Docs
...
# Run a Dynamics 365 model-driven app on a mobile device

After the app is created and then shared with you, you can run that app on the Dynamics 365 mobile app or in a web browser on tablet. In this topic, you'll learn how to run Dynamics 365 model-driven app on a mobile device. 
