...
## Offline status page
When you select the offline sync icon, the **Offline Status** page is displayed. The **Offline Status** page provides detailed information about the sync status, such what data was downloaded and if there is data to upload, as shown in the following image.
