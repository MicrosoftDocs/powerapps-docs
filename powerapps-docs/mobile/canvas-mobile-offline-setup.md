...
3. [Generate a default profile](setup-mobile-offline.md#generate-a-default-profile) and [add tables to the offline profile and apply filters](hsetup-mobile-offline.md#add-a-table-to-an-offline-profile-and-apply-filters).
