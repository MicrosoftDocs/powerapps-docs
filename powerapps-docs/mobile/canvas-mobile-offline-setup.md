...
- You must be running a recent version of Power Apps mobile app. Be sure your mobile device is running on one of the following versions or later.
  ...
  | Operating sytem | Version of Power Apps mobile app |
  |-----------------|---------|
  | iOS     | X    |
  | Android | X   |
  | Windows | X   |
...
The mobile offline profile is auto-generated by default. However, it is possible to create and assign an offline profile to a canvas app. More information: [Offline profile guidelines](mobile-offline-guidelines.md)
