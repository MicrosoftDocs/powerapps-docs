...
3. Search for **WebView** and make sure you have version **99.0 or later**. If you have an earlier version, then follow the steps in [WebView 2 Runtion](windows-app-install.md#webview2-runtime)section.
