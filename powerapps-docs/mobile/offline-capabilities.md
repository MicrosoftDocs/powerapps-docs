...
- **Advanced lookups**: The [**Advanced lookup**](../user/lookup-field#advanced-lookup.md) functionality isn't supported in offline scenarios. When you're offline, the **Advanced lookup** button is replaced by a **Change view** dropdown list.
