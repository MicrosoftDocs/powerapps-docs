...
When you enable model-driven apps for offline use, you'll also have better device performance, as the app is more resonsive, and you save on battery power with less connections made to the server. However, you do need internet connections to sync your data back and forth with Microsoft Dataverse.
