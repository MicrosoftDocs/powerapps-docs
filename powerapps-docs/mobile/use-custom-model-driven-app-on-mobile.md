...
- The **Show Chart** command has been moved from the main set of commands to an overflow menu. This gives priority to other commands including custom commands. 
