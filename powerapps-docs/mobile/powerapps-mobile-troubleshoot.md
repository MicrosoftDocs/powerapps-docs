...
Monitor is a tool that offers makers a deep view of what an app does and how it does it by logging all key activities that occur in the app as it runs. You can [connect a mobile app session to Monitor](../maker/monitor-canvasapps.md#for-mobile-apps) to better diagnose and troubleshoot issues faster.
...
1. Uninstall the Microsoft Authenticator app.
1. Uninstall Power Apps mobile.
1. Reinstall the Microsoft Authenticator app and add your back up account.
1. Reinstall [Power Apps mobile](../mobile/run-powerapps-on-mobile.md).
1. Open Power Apps mobile and then sign in.
