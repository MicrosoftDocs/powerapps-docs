---
title: Supported platforms for running model-driven apps using the Power Apps mobile app | Microsoft Docs
description: System requirements, limits, and configuration values for model-driven app using Power Apps mobile
author: mduelae
