...
Each Many-to-Many relationship includes [ManyToManyRelationshipMetadata.Entity1LogicalName> and [ManyToManyRelationshipMetadata.Entity2LogicalName>. For this documentation relationship details are only included in the topic for *Entity1*. Each Many-to-Many relationship where the entity is *Entity2* includes only a link to the details found in the topic for *Entity1*.
