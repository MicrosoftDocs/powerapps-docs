            ...
            <ul id="home">
               ...
               <li>
                  ...
                  <ul id="user"
                     ...
                     <li>
                        <div class="container">
                           <p>App users can <a href="/powerapps/user">find and run</a> apps created by them or by others on a phone, tablet or web browser.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <ul>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/add-configure-controls"></a>Design the interface</p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/working-with-formulas"></a>Configure app functionality</p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/edit-app"></a>Manage an app</p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/data-integrator">Integrate data into Common Data Service</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/power-platform/admin/environments-administration">Manage environments</a></p>
               ...
               <li>
                  ...
                  <ul id="developer"
                     ...
                     <li>
                        <div class="container">
                           <p>Developers are <a href="/powerapps/?branch=release-crm-mig-vivek#pivot=home&panel=maker">app makers</a> who can use code to extend business apps and create client applications that connect to Common Data Service.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/overview">Common Data Service: Developer overview</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Work with Common Data Service data</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Work with Common Data Service metadata</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/workflow/workflow-extensions">Workflow extensions (Common Data Service)</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Integrate data with Common Data Service</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Create client applications for Common Data Service</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Web API Reference</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/clientapi/reference">Client API Reference</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Samples</h3>
                                    <hr/>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/org-service/quick-start-org-service-console-app">Quickstart: Organization service sample</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/clientapi/walkthrough-write-your-first-client-script">Quickstart: Client API sample</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/web-api-samples-csharp">Web API samples</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/org-service/samples/convert-fax-task">Organization service samples</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
