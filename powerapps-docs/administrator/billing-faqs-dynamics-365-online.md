...
## What billing activities do I need to contact Dynamics 365 (online) Billing Support to manage?  
 ...
 You can resolve many billing-related issues by yourself, but there are some requests that only billing support can resolve. Please refer to the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page if you want to do any of the following:  
...
## When I renew my subscription, can I change my payment method?  
 During subscription renewal, you can move from credit card to invoice payment, but not from invoice to credit card. Please refer to the **Dynamics 365 (online)** tab on the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page if you wish to change from invoice to credit card payments at subscription renewal time.  
...
## How do I cancel my Dynamics 365 (online) subscription?  
 ...
 You’ll need to contact billing support to cancel your subscription. To contact billing support, please refer to the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page.  
...
1.  Do you want to keep your existing data? If so, you can export it to [!INCLUDE[pn_MS_Excel_Full](../includes/pn-ms-excel-full.md)]. For more information, see [Export Data to Excel](https://docs.microsoft.com/dynamics365/customer-engagement/basics/export-data-excel).  
...
## How do I reactivate my expired Dynamics 365 (online) account?  
 ...
 To reactivate an expired [!INCLUDE[pn_CRM_online](../includes/pn-crm-online.md)] account, you’ll need to contact billing and subscription support. Please refer to the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page.  
...
## How do I apply for a credit due to a Dynamics 365 (online) service outage?  
 ...
 Submit a claim by contacting Billing support. To contact billing support, please refer to the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page.  
...
## How to change the Bill to country/region  
 You need to create a new tenant and the desired bill-to-country/region and purchase the desired offer on the new tenant. You’ll have to manually export data from the old tenant and import into the new tenant. Finally, you’ll contact Billing Support to cancel your subscription. To contact billing support, please refer to the [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support) page. If you require assistance with migrating the data, contact [Technical support](contact-technical-support.md).  
  
### See also  
 [Billing support](https://docs.microsoft.com/dynamics365/customer-engagement/admin/billing-support)   
 [Find your Dynamics 365 administrator or support person](https://docs.microsoft.com/dynamics365/customer-engagement/basics/find-administrator-support)
