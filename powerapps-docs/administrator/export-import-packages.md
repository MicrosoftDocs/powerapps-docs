...
## Data
You can't move database data as part of the export and import of resources. To move data, you can use Microsoft Excel. For more information, see [Import or export data](../common-data-service/data-platform-export-data.md).
