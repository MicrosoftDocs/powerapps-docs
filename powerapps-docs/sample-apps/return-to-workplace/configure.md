...
For demo purposes, the solution includes sample data for the different entities in the solution. We recommend that you import your own data and remove this data from the following entities:
...
The sample data is also includes two flows. You must disable these flows when you're not using sample data.
