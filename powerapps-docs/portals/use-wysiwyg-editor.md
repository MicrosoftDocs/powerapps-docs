 ...
 **Note**: The editable elements are demarcated by a boundary.
 ...
 **Note**: You can upload only the images of type png, svg, jpg, and jpeg with the maximum size of 5 MB.
...
**Note**: You can also select the image on the canvas and drag the handles to resize it.
 ...
 **Note**: You can also select the IFrame on the canvas and drag the handles to resize it.
 ...
 **Note**: The default option for **Edit** and **ReadOnly** modes is set as Query String Parameter Name passed as ID in URL. To change these values, you need to open Portal Management app and update the form properties.
