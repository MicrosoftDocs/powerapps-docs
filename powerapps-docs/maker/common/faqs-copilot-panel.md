...
- This feature only supports limited controls and actions as listed in the [intended use](transparency-notes-copilot-panel.md#what-is-continue-to-edit-your-app-with-copilot) section. Microsoft is actively working on expanding the scope of this feature and support more actions incrementally. 
