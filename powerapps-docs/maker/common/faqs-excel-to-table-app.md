...
- The Copilot capability of Excel to table and app is currently only supported in [limited regions](https://learn.microsoft.com/power-apps/maker/common/faqs-excel-to-table-app#how-can-i-use-this-feature-in-a-power-platform-environment-that-is-created-outside-of-the-united-states-or-switzerland). Users are still able to use the upload and table and app creation feature without Copilot assistance.  
