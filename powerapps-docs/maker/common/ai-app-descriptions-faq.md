...
description: FAQ that discusses generate app descriptions with Copilot and the key considerations for making use of this technology responsibly.
ms.date: 7/21/2023
ms.custom: 
  - transparency-note
ms.topic: article
...
With the AI-generated app descriptions feature, Makers can use AI to generate descriptions for their Canvas apps. Makers will be able to generate a description either in the ‘App settings’ panel or in the ‘Publish’ dialog. By using AI to generate descriptions, Makers can focus on building their apps and allow AI to assist in summarizing the purpose of the apps for end-users. 
...
If you see an error like “Something happened and we weren’t able to generate a description for you”, this may be due to capacity limits. We recommend you give the system some time before trying again.
