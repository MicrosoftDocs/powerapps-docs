...
4. Add access policies for the Key Vault. For both **Secret permissions** and **Certificate permissions** for **Wrap Key Vault Access App** make that **Get** and **List** permission are selected.
