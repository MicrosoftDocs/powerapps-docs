...
- If your app displays a pop up that says that it is locked for editting by another user, ask the mentioned user to refresh their app and then refresh your app to remove the lock. 
