...
| Sources List (Items) | Data source (table) that lists [multiple media files to view](#viewing-multiple-models-in-a-single-session) in a single mixed reality session. | Table | Properties; Advanced: **Items** |
