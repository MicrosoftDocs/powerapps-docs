...
For this preview, Copilot in Power Apps is turned on by default. To disable it, you need to have administrator access.
...
> [!NOTE]
> Turning off Copilot for your tenant will only disable the Copilot for makers. It won't disable [Copilot control for canvas apps](add-ai-copilot.md) or [Copilot for model-driven apps](../model-driven-apps/add-ai-copilot.md).
