...
> [!NOTE]
> We currently do not support new features on Windows platform for PowerApps app. Features such as improved Common Data Service capabilities and guest access are available for PowerApps app on this platform. We recommend using web player on Windows to leverage the full set of capabilities. Updates to PowerApps app for Windows platform will be announced in future.
