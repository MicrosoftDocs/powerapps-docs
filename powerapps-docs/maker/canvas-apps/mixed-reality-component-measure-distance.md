...
ItemsBoxDraw	| A column in Items that specifies the Box Draw overrides (true, false, or blank) for the measurements you want users to capture. (Optional)	| ColumnName | **Advanced**
