...
ItemsMeasurementType  | A column in _Items_ with strings that specify the measurement type overrides (distance, area, volume, freeform, or null)  for the measurements you want users to capture. (Optional) | ColumnName | **Advanced**
ItemsBoxDraw	| A column in Items that specifies the Box Draw overrides (true, false, or null) for the measurements you want users to capture. (Optional)	| ColumnName | **Advanced**
