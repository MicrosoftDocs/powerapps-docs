...
| 4        | Disabled     | Disabled          | App experiences can be responsive. Makers can manulipate control locations using Power Fx to set X and Y values as well as Width and Height.                                                                                                        | Please review [responsive layout documentation](https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/create-responsive-layout), consider using auto-layout containers.       |
