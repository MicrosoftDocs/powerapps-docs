...
> - Embedding canvas apps in a any native desktop application isn't supported, which includes Andrioid and iOS. This excludes first-party integrations such as Power Apps in Teams).
