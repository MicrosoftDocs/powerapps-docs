...
Ideas, in the same feedback card, you will see a [Report it now](https://msrc.microsoft.com/report/abuse) link below the feedback box which can help us keep our AI model behaving in a responsible manner. Make sure to select Threat type as URL and Incident type as Responsible AI as shown in the following screenshot so we can try our best to respond in time.

:::image type="content" source="media/power-apps-ideas/GPT-3-feedback-channel.png" alt-text="Give us feedback.":::
