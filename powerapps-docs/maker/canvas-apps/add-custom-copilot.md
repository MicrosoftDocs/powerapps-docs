...
> [!IMPORTANT]
> - You can only use this feature on mobile devices. For web scenarios, this feature is set to be deprecated by September 2025. Use [Copilot control for canvas apps](../../maker/canvas-apps/add-ai-copilot.md) instead. 
