...
> [!IMPORTANT]
> Microsoft recommend to not use this feature on web but only mobile. Please use [Copilot control for canvas apps](../../maker/canvas-apps/add-ai-copilot.md) for web scenarios.
