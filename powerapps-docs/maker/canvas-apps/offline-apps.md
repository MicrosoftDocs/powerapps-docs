...
> [!NOTE]
> - Offline capability is now built-in with the preview of [offline-first](../../mobile/canvas-mobile-offline-setup.md) experience. Learn more: [Set up mobile offline for canvas apps (preview)](../../mobile/canvas-mobile-offline-working.md), [Working with canvas apps offline (preview)](../../mobile/canvas-mobile-offline-working.md)
