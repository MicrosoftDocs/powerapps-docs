...
4. As of this writing, stored procedures, tables with composite keys, and nested object types in tables aren't direclty supported in Power Apps.  Stored procedures are supported, however, via Power Automate.
