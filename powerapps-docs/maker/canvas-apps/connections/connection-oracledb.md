...
4. As of this writing, stored procedures, tables with composite keys, and nested object types in tables aren't direclty supported in Power Apps. However, stored procedures using Power Automate are supported.
