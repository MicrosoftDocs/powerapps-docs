...
**A:** Deleting a list associated with a form automatically deletes the form. If the list is restored from Recycle Bin, the form is also restored automatically with the list.
