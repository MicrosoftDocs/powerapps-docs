...
**A:** Deleting a list associated with a form automatically deletes the custom form. If a list is restored from Recycle Bin with a custom form, the form is also restored automatically with the list.
