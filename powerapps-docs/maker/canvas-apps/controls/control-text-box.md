...
**Live** – How the screen reader announces changes to the label's text.  Values can be **Off** **Assertive** and **Polite**. Useful for announcing dynamic changes in the app's UI in an accessible way.
