...
1. In the **Create a theme** dialog, enter the following information:
   ...
   - **Lock primary color (preview)**: How the 16-slot theme palette is generated using the seed color.
     - Disabled: the 16-slot palette is optimized for accessibility and is the default value.
   ...
   - **Torsion**: Impacts the tint, shade, or tone of the palette.
...
1. On the **Themes** pane, find the tile of the theme you want to edit and select the overflow menu and then **Edit**.
   ...
   :::image type="content" source="media/theme-options-edit.png" alt-text="Screenshot showing the location of the eclipses points where you can select Edit.":::
