...
2. Set the toggle for **Modern controls and themes** to **On**.

  > [!IMPORTANT]
  > Coming soon - the setting to enable modern controls will move to the **General** section instead of **Upcoming features**.
