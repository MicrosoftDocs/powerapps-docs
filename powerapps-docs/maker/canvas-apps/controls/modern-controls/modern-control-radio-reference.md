...
> [!NOTE]
> This article describes the Radio modern control. For information about migrating from the previous version, see [Migrate to the Radio modern control](radio-migration.md).
...
This new Radio modern control includes the following improvements:
...
- **Required validation**: When using **Required**, combine it with **ValidationState** to show visual feedback if the user hasn't made a selection.
...
- [Migrate to the Radio modern control](radio-migration.md)
