...
## Key properties
**[
](properties-core.md)** – The initial value of a control before it is changed by the user. You can only have one default selected item.  If you need multiple selected items please use the [Combo Box](control-combo-box.md) control.
