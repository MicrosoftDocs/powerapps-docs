...
**UseMobileCamera** – Whether to use a mobile camera directly, when available. Setting this to TRUE, forces users to click a picture from camera and disables uploading existing images from the device gallery.
