...
**Language** – Determines the language used to format dates, including names of months. If this property isn't specified, the user's device setting determines the language.  Expected strings such as "EN-us" or "FR".
...
**InputTextPlaceholder** – Instructional text shown to the end-user when no dates are entered.
