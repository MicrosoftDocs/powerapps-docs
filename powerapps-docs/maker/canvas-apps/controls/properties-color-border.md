...
Colors can be specified and calculated in many ways:  
* [**Color** enumeration](../functions/function-colors.md): **Color.Red** or **Color.Indigo**.  CSS color names can be used.
* [**ColorValue** function](../functions/function-colors.md): **ColorValue( "AliceBlue" )** or **ColorValue( "#ff00ff" )**.  CSS color names and **#** hex code notation is supported as a text string.  
...
* [**RGBA** function](../functions/function-colors.md): **RGBA( 255, 0, 255, 25% )**. The red, green, and blue components of a color are provided from 0 to 255, and alpha channel is given from 0% (fully transparent) to 100% (fully opaque). 
