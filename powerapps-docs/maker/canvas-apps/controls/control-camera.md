...
> - Mobile device camera might take a few seconds to initialize when using camera control. The time taken to initialize the device camera depends on the make and model of your mobile device.
