...
- The table contains two columns: 
	...
	- *Name* provided by the device to identify the camera.  On some platforms the word "Front" or "Back" may be included to help locate the camera.
- Not all devices in the table may be usable in your app.  Some may be specialized drivers or applications intended for specific purposes.  
