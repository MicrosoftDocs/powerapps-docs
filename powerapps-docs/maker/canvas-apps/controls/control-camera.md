...
1. [Add](../add-configure-controls.md) a **Camera** control.  By default it will be named **Camera1**; you will need to adjust the formula that follows if it is different.
