...
> [!NOTE]
> The camera control is only supported on Microsoft Edge, Chrome, Firefox and Opera browsers; and Android and iOS devices. All other browsers and platforms will show a warning that some app features won't work.
