...
- The table contains two columns: numeric *Id* to be used with the **Camera** property and a device provided text *Name* to help identify the camera.  On some platforms the word "Front" or "Back" may be included to help identify the location of the camera.
- Depending on the platform, not all devices in the list may be used in your app.  Some may be specialized drivers or applications.  
