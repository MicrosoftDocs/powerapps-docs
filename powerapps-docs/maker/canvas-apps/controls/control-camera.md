...
> - Mobile device camera might take a moment to initialize when using camera control. This time taken to initialize the device camera depends on the type of device you use.
