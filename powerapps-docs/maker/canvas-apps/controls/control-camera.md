...
> [!NOTE]
> Images generated by the camera control have a maximum resolution of 640 x 480. If you need full resolution images, use the [Add picture](control-add-picture.md) control.
