...
> [!NOTE]
> The camera control is supported only on Chrome, Edge, Firefox, and Opera as well as Android and iOS apps. On other browsers and platforms, users will see a warning that some features of the app won't work.
