...
> [!IMPORTANT]
>  Videos on Azure Media services are no longer supported due to [retirement of the service](https://learn.microsoft.com/en-us/azure/media-services/latest/azure-media-services-retirement). 
