...
**Transparency** – The degree to which controls behind an image remain visible. Decimal values range from 0 to 1.  Where 0 is transparent, 0.5 is semi-transparent and 1 is opaque. 
