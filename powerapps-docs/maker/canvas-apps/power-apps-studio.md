...
- **Variables**(preview): Work with [[variables](working-with-variables.md](working-with-variables.md and [collections](create-update-collection.md) while editing your app.
