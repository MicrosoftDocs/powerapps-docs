...
:::image type="content" source="media/studio/pa-studio-screen-selector.png" alt-text="Screenshot that shows the location of the screen selector." lightbox="media/studio/pa-studio-screen-selector.png":::
