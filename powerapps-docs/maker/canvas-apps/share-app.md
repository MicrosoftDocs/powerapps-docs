...
As the guest user, open the email sent when an app in the guest tenant was shared, click the 'Open the app' button. This applies to both Azure Active Directory and Microsoft Account users.   
