...
> [!NOTE]
> Power Apps does not yet formally support Service Principal types of authentication. For more information, see [Authentication methods using Microsoft Entra ID](/azure-sphere/deployment/authenticate-options).
