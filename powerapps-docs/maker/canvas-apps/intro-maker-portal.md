...
- **Start with data**: Lets you upload an [Excel file](tbd), [build your own table](tbd), select a [Dataverse table](data-platform-create-app.md), or choose from external data source such as [SharePoint](/app-from-sharepoint.md), [Excel](get-started-create-from-data.md), or [SQL](app-from-azure-sql-database.md) to start building your app.
