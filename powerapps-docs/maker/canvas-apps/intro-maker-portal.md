...
Find what you need with the new left navigation pane. If this is the first time, you're signing in to the [Power Apps home page](https://make.powerapps.com) the left navigation pane shows the following menu items:
...
- **Pick an app template**: Choose from a fully functional app and then customized it based on your organization needs. More information: [Create a canvas app from a template](get-started-test-drive.md)
