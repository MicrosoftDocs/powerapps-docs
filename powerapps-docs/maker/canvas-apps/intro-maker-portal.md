...
- **Your most used pages such as Tables, Connections, Flow**: When you first sign in to the new navigation experience the top three pages that you use most are pinned to the left navigation pane. Use the **More** option to unpin any of these pages and pin something else.
...
If you've already pinned a page, to unpin it, select the more button next to the page and they select **Unpin**.
