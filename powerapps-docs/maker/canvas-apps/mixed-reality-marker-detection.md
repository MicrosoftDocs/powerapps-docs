...
:::image type="content" source="./media/augmented-marker-detection/mixed-reality-marker-1.png" alt-text="Image used for marker detection in mixed reality experiences" lightbox="media/paygo_detailedusage.png":::
