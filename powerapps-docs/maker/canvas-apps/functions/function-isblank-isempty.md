...
3. Preview your app, click or tap the button that you added, and then close Preview.  
    ...
    ![Example of collection named IceCream](media/function-isblank-isempty/icecream-strawberry-chocolate.png)
...
5. Preview your app, click or tap the second button, and then close Preview.  
    ...
    ![IceCream example preview and empty](media/function-isblank-isempty/icecream-clear.png)
