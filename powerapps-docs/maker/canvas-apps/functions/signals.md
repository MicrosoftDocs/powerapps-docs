...
| **App.Width** | Returns the width of the app playing window, which can be used to set the Width property of the screen in order to build a responsive app.  |
| **App.Height** | Returns the height of the app playing window, which can be used to set the Height property of the screen in order to build a responsive app. |
