...
To verify and/or modify the enabled status of the Power Apps-Advisor enterprise application identity
...
![Enable Power Apps-Advisor app](media/solution-checker-enable-app.png)
