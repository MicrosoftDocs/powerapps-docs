...
- Make you solutions segmented as you build a new app. To do this you add specific components to control what goes into the solution. More information: [Create a segmented solution with entity assets](#create-a-segmented-solution-with-entity-assets)
- Make segmented solutions to build and  release minor updates to a parent solution. To do this you clone a patch. More information: [Create a solution patch](#create-a-solution-patch)
- Make segmented solutions to build and release major updates to a parent solution. To do this, you clone the solution. More information: [Clone a solution](#clone-a-solution)
