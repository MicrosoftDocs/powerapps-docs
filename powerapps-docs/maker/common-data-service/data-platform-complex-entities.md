...
description: A list of complex tables in Common Data Service that require a Power Apps Plan 2 license.
author: KumarVivek
...
> [!NOTE]
>  If you are using the Common Data Service and have not installed a Dynamics 365 app or third-party solution, your environment won't have tables containing complex server-side logic.
