...
- Canvas app button triggered flows are not currently supported in solutions. Create the app and flow outside of a solution and export the .msapp file to migrate canvas apps with an embedded button triggered flow. 
