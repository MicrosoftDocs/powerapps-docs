...
|OneNote     | App users can use OneNote to take or review notes from within Common Data Service rows.      |   [Set up OneNote integration](/dynamics365/customer-engagement/admin/set-up-onenote-integration-in-dynamics-365)   | 
