...
3. In the **New table** panel, enter the following information columns. Required columns are designated with an asterisk (*) next to the column label. 
    ...
    |**Collaboration**     |  **Allow feedback**     |  Let customers write feedback for any table record, or rate table rows within a defined rating range. Once enabled this setting can't be disabled. More information: [Configure an table for feedback/ratings](configure-table-feedback.md)    |
