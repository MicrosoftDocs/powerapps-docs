...
You can use [column](../working-with-tables.md#columns)-level information to validate user input and provide immediate feedback to the user before using the **[Patch](../../functions/function-patch.md)** function. The **[Validate](../../functions/function-validate.md)** function uses this same information.
