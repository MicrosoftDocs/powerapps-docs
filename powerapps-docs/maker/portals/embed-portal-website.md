...
In this scenario, it's easier to embed your portal functionality rather than building it from scratch. This article explains the steps to embed a portal application in a different website by using an iframe.
