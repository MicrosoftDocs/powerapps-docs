...
> [!NOTE]
> Notes description must have ***\*WEB\**** (that is 'WEB' keyword with asterisk (\*) before and after) text present in order to display on the portal. Therefore, ensure you add the ***\*WEB\**** text in description of notes if you create notes directly in Common Data Service.
