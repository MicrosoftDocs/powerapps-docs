...
When **Page available to everyone** is set to **Off**, the page isn't available everyone by default. You can select specific roles that you want to grant access to this page.
...
When **Permissions apply to child files** is set to **On**, the child [web files](web-files.md) of that page are only available to the users that can access this web page. When set to **Off**, everyone can access the child web files of the selected page, including anonymous users.
...
![Inherit permissions](media/webpage-access-control/restricted-lock.png "Inherit permissions")
