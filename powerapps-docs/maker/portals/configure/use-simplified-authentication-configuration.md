...
| Other | OpenID Connect | Allows configuration of any provider that conforms to the [OpenID Connect](https://openid.net/specs/openid-connect-core-1_0.html) protocol specifications. <br> Examples: <br> - [Configure Azure AD as the OpenID Connect provider](configure-openid-settings.md) <br> - [Configure Azure AD B2C as the OpenID Connect provider](configure-azure-ad-b2c-provider.md) |
