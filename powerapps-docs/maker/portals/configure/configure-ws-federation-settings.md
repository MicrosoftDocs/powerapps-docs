...
|          Authentication/WsFederation/ADFS/Caption           |                                                                                                           Recommended. The text that the user can see on a sign-in user interface. <br> Default: ADFS.  |
...
|     Authentication/WsFederation/ADFS/BackchannelTimeout     |                                                                                                         Time out value for back channel communications. <br> Example: `00:05:00` (5 mins). |
