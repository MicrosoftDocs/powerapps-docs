...
To secure these features, table permissions allow for granular rights to be granted for arbitrary tables and for record-level security to be enabled via relationship definitions.
