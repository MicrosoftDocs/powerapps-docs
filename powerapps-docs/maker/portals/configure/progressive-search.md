...
- Since the records are progressively evaluated, the jump to last page button (![Jump to last page button](media/progressive-search/last-page-button.png "Jump to last page button")) is available only if the remaining number of pages in the search result are five or less.
