...
| Access Denied Message      | Overrides the default HTML message that appears when a user does not have sufficient [permissions](assign-table-permissions.md) to read the table type associated with the subgrid.                       |
