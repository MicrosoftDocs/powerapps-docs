...
| [Update portal packages](update-portal-solution) | User account with [Read-Write Access Mode](#read-write-access-mode) and [System administrator](#system-administrator) |
