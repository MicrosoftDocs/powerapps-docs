...
> [!IMPORTANT]
> You can add a custom domain name to a portal only when the portal is in production state. For more information, go to [portal lifecycle](portal-lifecycle.md).
