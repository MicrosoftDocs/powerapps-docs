...
1. Transfer the portal metadata from the source environment using the [Power Platform CLI](#power-platform-clitabcli) or the [Configuration Migration Tool](#configuration-migration-tooltabcmt). 
