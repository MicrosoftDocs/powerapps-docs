...
1. Transfer the portal metadata from the source environment using the [Power Platform CLI](#transfer-portal-configuration-using-power-platform-cli) or the [[Configuration Migration Tool](#tab/CMT)](#configuration-migration-tooltabcmt)
