...
| adxPreviewUnpublishedEntities | Holds preview **ON/OFF** mode used in classic CMS system for portal administrators. | Session |
...
| timeZoneCode | Holds the *timezonecode* field value of *CRM timezonedefinition* entity for the current timezone. | Session |
| timezoneoffset | Holds the [timezone difference](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date/getTimezoneOffset) between UTC and Local browser time. | Session |
