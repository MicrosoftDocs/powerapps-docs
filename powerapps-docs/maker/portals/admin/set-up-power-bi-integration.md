---
title: How to set up Power BI integration
...
3. In the **Enable Power BI Embedded service integration** window, select the available workspaces from which you want dashboards and reports to be displayed in your portal. Move these to the **Selected Workspaces** list.
...
4. Select **Enable**. While Power BI Embedded service is being enabled, the portal will restart and be unavailable for a few minutes. A message will appear when Power BI Embedded service has been enabled.

### Create security group and add to Power BI account

After enabling Power BI Embedded service, you must create a security group in Azure Active Directory, add a group member, and then add the security group through the Power BI admin portal. This allows the dashboards and reports created in new Power BI workspaces to be displayed in the portal.
...
- [Row-level security](/power-bi/admin/service-admin-rls) in Power BI is enabled but you didn't pass roles in [Power BI component configuration](../add-powerbi.md) (Advanced settings), or specify the *roles* parameter in the [powerbi Liquid tag](../liquid/portals-entity-tags.md#powerbi).
