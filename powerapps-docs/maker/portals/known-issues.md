...
> - Some terminology in Microsoft Dataverse has been updated. For example, *table* is now *table* and *field* is now *column*. [Learn more](../data-platform/data-platform-intro.md)
>
