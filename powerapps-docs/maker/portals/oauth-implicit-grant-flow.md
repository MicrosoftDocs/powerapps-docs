...
description: "Learn how to make client-side calls to external APIs and secure them by using OAuth implicit grant flow in the Dynamics 365 Portal."
author: sbmjais
manager: shujoshi
...
You can use the following sample code to get started with using OAuth 2.0 Implicit Grant with Dynamics 365 Portal APIs.

### Use Portal OAuth token with an external Web API

This sample is an ASP.NET based project and is used to validate the ID token issued by Dynamics 365 Portal. The complete sample can be found here: [Use Portal OAuth token with an external Web API](https://github.com/microsoft/PowerApps-Samples/tree/master/portals/ExternalWebApiConsumingPortalOAuthTokenSample).
...
This sample shows how you can use the getAuthenticationToken function to fetch an ID token using the Token endpoint in Dynamics 365 Portal. The sample can be found here: [Token Endpoint sample](https://github.com/microsoft/PowerApps-Samples/blob/master/portals/TokenEndpoint.js).
