---
title: Add image
description: Learn how to add image component to a Power Apps portals page using portals Studio.
...
1. Under **Portal components**, select **Image**. The image placeholder is added to the canvas.
