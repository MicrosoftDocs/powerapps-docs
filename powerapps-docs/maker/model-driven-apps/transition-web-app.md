...
This quick start topic explains how to transition your Dynamics 365 for Customer Engagement apps Web Client application to Unified Interface. The Unified Interface framework uses responsive web design principles to provide an optimal viewing and interaction experience for any screen size, device, or orientation. 

## Prerequisites
- A Dynamics 365 for Customer Engagement apps Web Client application. 
