...
> - This feature is only available in standalone model-driven apps which do not include both lead and opportunity tables. This feature isn't yet supported for Dynamics 365 apps.
