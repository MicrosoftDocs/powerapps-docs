...
> [!TIP]
> You can use the model app-builder skill with an AI code generation tool to plan, build, and edit a model-driven app from natural-language requirements. For more information, see [Build and edit model-driven apps with AI code generation tools](model-driven-app-external-tools.md).
