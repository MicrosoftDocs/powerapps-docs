...
description: "Learn how to add Power BI visuals into model-driven apps with Power Apps"
ms.date: 03/30/2026
ms.topic: tutorial
author: Mattp123
ms.author: matp
...
If you don't already have a workspace with a Power BI report, follow these steps to create one. If you already have a workspace, go to [Add the dashboard and report to a solution](#add-the-dashboard-and-report-to-a-solution).
...
1. When the file is uploaded, select **Sign in**, and then select **Next**.
...
1. Now, build a visual:
   ...
   - Select the chart and then select the forked double arrows to show quarters, and then select them again to show months.
...
1. Select the **Test Power BI report** you created earlier, and then select **Add**.
   ...
   The report loads in the app designer similar to how it appears to your users when they play the app.
...
1. Select **Save and publish** to save and publish you app making it available for users.
