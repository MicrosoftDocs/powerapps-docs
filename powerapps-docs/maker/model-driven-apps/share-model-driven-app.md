---
title: Share a model-driven app | Microsoft Docs
...
# Preview feature: Share a model-driven app with PowerApps
...
## Prerequisites
To share an app you must have the [!INCLUDE [powerapps](../../includes/powerapps.md)] Environment Admin or Environment Maker role. 
...
|System Administrator     |  Create, Read, Write, Delete, Customizations, Security Roles       | Has full permission to customize or administer the environment and can view all data in the environment. More information: [Privileges required for customization](https://docs.microsoft.com/dynamics365/customer-engagement/customize/privileges-required-customization)        |
