...
> [!TIP]
> Use the model app-builder skill with an AI code generation tool to plan, build, and edit a model-driven app from natural-language requirements. After the skill creates or updates the app, you can continue working with its standard Power Apps artifacts in the app designer and other Power Apps designers. For more information, see [Build and edit model-driven apps with AI code generation tools](model-driven-app-external-tools.md).
...
[Build and edit model-driven apps with AI code generation tools](model-driven-app-external-tools.md)
