...
1. If you have the Power BI Extensions (Preview) system solution installed, you can select a solution-aware Power BI report to be embedded in a system dashboard. You'll see the **Show reports in this environment only** option selected, and the dedicated environment Power BI workspace is pre-selected for you. To install the solution, select the Power BI Extensions solution. More information: (Install an app)[/power-platform/admin/manage-apps#install-an-app]
