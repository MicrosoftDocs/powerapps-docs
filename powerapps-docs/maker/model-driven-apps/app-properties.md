...
- **Try the new look**. Enabled by default, this feature determines whether end users see the modern refresh app experience or the classic look. This setting will be hidden and ignored with the **2026 Wave 1** release when the new look becomes mandatory. More information: [Modern, refreshed look for model-driven apps](../../user/modern-fluent-design.md)
