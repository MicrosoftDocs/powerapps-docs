...
- **Try the new look**. This feature enables the new look for existing and new model-driven apps. Enabled by default this setting will show end users a "Try the new look" switch to enable the new experience. End users can switch back at anytime. More information: [Modern, refreshed look for model-driven apps (preview)](../../user/modern-fluent-design.md)
...
- **Try the new look and feel (preview)**. This is a preview feature that enables the new look for existing and new model-driven apps. This setting is disabled by default and will not affect the model-driven app until enabled. This app setting has no effect when 2023 Release Wave 2 is enabled. More information: [Modern, refreshed look for model-driven apps (preview)](../../user/modern-fluent-design.md)
