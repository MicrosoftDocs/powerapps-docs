...
- Follow general best practices for client scripting. More information: [Client scripting in model-driven apps](../developer/model-driven-apps/clientapi/client-scripting-best-practices.md)
