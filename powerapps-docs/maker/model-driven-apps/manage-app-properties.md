---
title: "Manage model-driven app properties in the Power Apps app designer (classic)"
...
> [!NOTE]
> This article describes how to view and set app properties using the classic app designer. For information how to view and set app settings in the modern designer, go to [Manage model-driven app settings in the app designer](app-properties.md).
...
2. Change the information, as required:  
    ...
    |**Unique Name**| You can't change the unique name. Using the unique name, you can query tables to get data from the database.|
