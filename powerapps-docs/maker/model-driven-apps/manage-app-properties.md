...
2.  Change the information, as required:  
    ...
    |**Client<sup>1</sup>**|Defines the type of client that the app will be used for.<br/>-  **Web:** This is the classic Dynamics 365 customer engagement web browser client.<br/>-  **Unified Interface:** This is the new web browser client that has a similar interface across PC and mobile devices.|
