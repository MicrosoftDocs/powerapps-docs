...
- **Public view** - Public views are general purpose views that you can customize as you see fit. They are important because all app users will see them, when the are made available, by using the view selector.  It is possible to use public views in sub-grids in a form or as a list in a dashboard.
