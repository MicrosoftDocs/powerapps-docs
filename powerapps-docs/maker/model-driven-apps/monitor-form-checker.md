...
- [Why aren't rows showing in the related menu of a table?](troubleshoot-forms.md#related-menurelated-tab)
- [Why is a control not editable?](troubleshoot-forms.md#why-a-control-is-disabledenabled-or-visiblehidden)
