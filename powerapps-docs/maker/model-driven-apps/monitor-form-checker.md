...
1. The model-driven app required.
1. To create a monitoring session, select **...** next to the model-driven app or on the global command bar, and then select **Monitor**.
