...
Comments in model-driven apps aren't supported for export and import with solutions. However, you can export the **Comment** table to Excel and then import the Excel file into the environment you want. More information: [Export data](../data-platform/data-platform-import-export.md#export-data)
