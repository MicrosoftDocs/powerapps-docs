...
1. In the details section, change the "Credentials to use" field to "Maker-provided credentials" to enable the MCP Server to be initialized autonomously. See [Control maker-provided credentials for authentication](https://learn.microsoft.com/en-us/microsoft-copilot-studio/configure-no-maker-authentication#scope-of-enforcement-and-experience) for more details if this option is disabled.
