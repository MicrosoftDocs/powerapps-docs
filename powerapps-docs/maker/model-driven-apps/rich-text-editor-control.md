...
1. Sign in to [Power Apps](https://make.powerapps.com/?powerappsEntities.enableModernColumn=true). Note: The parameter in the URL is required to be able to see the new **Format** option in the maker experience.
