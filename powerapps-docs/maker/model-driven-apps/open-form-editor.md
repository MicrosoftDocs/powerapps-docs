...
3.  Open the entity with the form you want to edit. If the entity isn't there, you'll need to add it. More information: [Add an entity to an unmanaged solution](#add-an-entity-to-an-unmanaged-solution)
