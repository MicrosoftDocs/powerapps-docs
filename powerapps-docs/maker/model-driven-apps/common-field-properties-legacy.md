...
||**Availability**|Choose if you want the field to be available on the phone.|
||**Related Records Filtering**|Only show records in the drop down where the value selected is contained in related table.
