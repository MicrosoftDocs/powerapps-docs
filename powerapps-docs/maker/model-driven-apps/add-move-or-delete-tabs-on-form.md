---
title: "Add, configure, move, or delete tabs on a form using the form designer"
...
> :::image type="content" source="media/FormDesignerComponentsLayout.png" alt-text="Layout components.":::
...
3. In the **Components** pane, select a tab component, such as a *1-column tab*, and drag and drop it onto the form preview. As you drag the tab on the form preview, you notice drop targets where you can add the tab.
...
4. Repeat step 3 if you want to add more tabs.
...
1. Open the form designer to create or edit a form. More information: [Create a form](create-and-edit-forms.md#create-a-form) or [Edit a form](create-and-edit-forms.md#edit-a-form)
2. In the form preview, select another existing tab or the form canvas. Note the following behavior:
    - When you select an existing tab, the new tab is added after the existing tab.
    - When you select the form canvas, the new tab is added as the last tab on the form.
3. On the command bar, select **Component**, or in the left pane, select **Components**.  
...
5. Repeat steps 2-4 if you want to add more tabs.
...
These properties are available to configure a tab when you create or edit a form using the form designer.

|Area   |Name  |Description  |
|---------|---------|---------|
|**Display options** | **Label** | The localizable label for the tab visible to users. <br /><br />This property is required. |
...
| **Display options** | **Hide** | When selected, tab is hidden by default and can be shown using code. |
...
| **Formatting**  | **Column Width**  | Enter the column width. Valid values are 1 to 100. The default is 100.  |
...
1. Open the form designer to create or edit a form. More information: [Create a form](create-and-edit-forms.md#create-a-form) or [Edit a form](create-and-edit-forms.md#edit-a-form)
2. In the form preview, select the tab header of the tab that you want to move and drag and drop it. As you drag the tab on the form preview, you see drop targets where you can move the tab. Note the following behavior:
    - Tabs can be dropped before or after any existing tabs by hovering over the tab headers.
    - Tabs can also be dropped before or after the current tab by hovering over the left or right edge of the current tab.
...
6. Repeat steps 2-5 if you want to move more tabs.
