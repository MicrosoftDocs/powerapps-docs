...
3. On the app designer canvas, select the down arrow ![Down arrow for app designer](media/down-arrow-app-designer.png) next to an entity to see the forms available for that entity. 
