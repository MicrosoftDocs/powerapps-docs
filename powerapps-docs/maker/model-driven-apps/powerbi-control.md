...
1. Choose from the following properties: 
   - **Report**. Select the Power BI report that you want displayed on the form. More information: [Create Power BI report and dataset components](/power-apps/maker/model-driven-apps/create-edit-powerbi-report-dataset-components).
