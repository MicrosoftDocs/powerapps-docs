...
> [!IMPORTANT]
> Learning Path is only available with legacy web client apps. Use custom help pages for Unified Interface apps. More information: [Create guided help for your Unified Interface app](../common-data-service/create-custom-help-pages.md)
