...
1. Publish the app.
1. Select the desired table view from the **Pages** area in the app designer.
...
1. On the **Add JavaScript Library** list, select **+ New web resource** to create a new JavaScript web resource.
1. On the **New web resource** pane, enter a **Name**, and optionally a **Display name** and **Description**.
1. For **Type**, select **JavaScript (JS)**.
1. In the **Code** box, paste your JavaScript. For example, depending on the type of dialog you want to use, copy and paste an example from [the Navigate API reference](../../developer/model-driven-apps/clientapi/navigate-to-custom-page-examples.md) .
1. Select **Save and publish** to save and publish the web resource.
...
1. In the **Command** properties pane, if the name isn't specified, enter the name of the JavaScript **Function**. In this example, *openDialog* is entered.
   > [!div class="mx-imgBorder"]
