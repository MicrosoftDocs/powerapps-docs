---
title: "Edit a canvas app embedded on a model-driven form"
...
This article explains how to edit a canvas app embedded on a model-driven form by using the classic designer.

## Edit the canvas app directly

You can edit a canvas app embedded on a model-driven form just like any other canvas app. For steps on editing a canvas app go to: [Edit a canvas app](../canvas-apps/edit-app.md)
