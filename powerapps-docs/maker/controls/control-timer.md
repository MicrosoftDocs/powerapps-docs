...
4. Add a label, and set its **[Text](../../controls/properties-core.md)** property to this formula:
...
5. (optional) Set the timer's **[Visible](../../controls/properties-core.md)** property to **false**.
