...
* In **View** mode, child controls such as **[Text input](../../controls/control-text-input.md)**, **[Drop down](../../controls/control-drop-down.md)**, **[Date Picker](../../controls/control-date-picker.md)** will only display the text value and will not render any interactive elements or decorations.
