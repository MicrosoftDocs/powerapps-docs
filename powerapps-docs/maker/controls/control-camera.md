...
3. Add an **[Image gallery](../../controls/control-gallery.md)** control, and then resize its **[Image](../../controls/control-image.md)** control, its template, and the **Image gallery** control itself to fit in the screen.
