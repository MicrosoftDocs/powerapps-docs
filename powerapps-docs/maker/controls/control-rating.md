...
2. Add a **[Text input](../../controls/control-text-input.md)** control, name it **Qualitative**, and move it below the **Rating** control.
3. Set the **[Default](../../controls/properties-core.md)** property of the **[Text input](../../controls/control-text-input.md)** control to **""**, and set its **HintText** to this formula:
...
4. Press F5, and then click or tap either four or five stars in the **Rating** control.
    ...
    The hint text in the **[Text input](../../controls/control-text-input.md)** control changes to reflect the high rating.
5. Click or tap fewer than four stars in **Quantitative**.
   
    The hint text in the **[Text input](../../controls/control-text-input.md)** control changes to reflect the low rating.
