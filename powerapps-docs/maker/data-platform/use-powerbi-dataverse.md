...
- **Power BI components**: Power BI report and dataset components make it possible to add Power BI reporting to Power Apps solutions in a way that enables you to seamlessly manage you Power BI data as part of your ALM process across environments and tenants. More information: [Create or edit Power BI report and dataset components](../model-driven-apps/create-edit-powerbi-report-dataset-components.md)
