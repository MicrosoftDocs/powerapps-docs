...
- **Power BI components**: Power BI report and dataset components make it possible to add Power BI reporting to Power Apps solutions in a way that enables seamless management the Power BI data as part of the ALM process across environments and tenants.
