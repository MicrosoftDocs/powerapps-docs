...
- If you don’t have Power BI premium license or Fabric capacity within the same region, you buy a capacity in the region or sign up for a free Fabric trial capacity. More information: [Fabric (preview) trial](/fabric/get-started/fabric-trial)
   ...
   > [!NOTE]
   > This won't be a prerequisite in the update expected in all regions by 30-Apr. When no longer required, you can link to a workspace within the same country or geo boundary even if you don't have a capacity within the same Azure region.
...
8. All Dataverse tables where "Change tracking" property is enabled are linked to Fabric. If this environment is linked to finance and operations apps, you can add finance and operations tables later using the Manage tables option. More information: [Manage link to Fabric](#manage-link-to-fabric).
