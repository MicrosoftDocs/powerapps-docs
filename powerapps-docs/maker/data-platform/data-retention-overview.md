...
> - Customers must have Power Apps [managed environment](https://learn.microsoft.com/power-platform/admin/managed-environment-overview), including Dynamics 365 customers and will be required to upgrade to managed environment if the environment is not already
> AND
> - Minimum of 1000 Dynamics 365  licenses OR 1000 Power Apps per user licenses, OR 1000 licenses from a combination of both in a single tenant
>
