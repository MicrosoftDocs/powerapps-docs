...
-   **DLP.** If you use DLP policies to block "HTTP with Azure AD" connector then Sharepoint connector and OData connector will fail. "HTTP with Azure AD" connector needs to be allowed in DLP policies for Sharepoint/OData connector to work. 
