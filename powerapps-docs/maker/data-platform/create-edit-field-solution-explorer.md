...
|**Auditing**|Whether data for this column is audited when the table is enabled for auditing. More information: [Manage Dataverse auditing](/power-platform/admin/manage-dataverse-auditing)|
