...
changes, retrieve operations, export operations, or during authentication. For information about how to configure auditing, see [Configure tables and attributes for auditing](power-platform/admin/manage-dataverse-auditing#enable-or-disable-entities-and-fields-for-auditing).
