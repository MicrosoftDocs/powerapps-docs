...
changes, retrieve operations, export operations, or during authentication. For information about how to configure auditing, see [Manage Dataverse auditing](power-platform/admin/manage-dataverse-auditing).
