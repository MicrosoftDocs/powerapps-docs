...
For more information about creating table relationships, see [Create a relationship between tables](/learn/modules/create-relationship-between-cds-entities/).
