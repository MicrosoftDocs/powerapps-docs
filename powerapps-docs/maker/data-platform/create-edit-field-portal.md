...
| **Prompt**  | Holds textual inputs that serve as prompts for AI models. These prompts can be anything from simple commands to complex queries. More information: [Prompt columns](prompt-column.md) |
