...
| **Allow form fill assistance (preview)**  | This is a preview feature. When enabled, users receive suggestions generated by AI for columns that support form fill assistance in main and quick create forms. You can disable for columns that might contain sensitive information, such as email address. Requires the **AI form fill assistance** environment setting enabled. More information: [Use Copilot's form fill assistance feature in model-driven apps](../../user/form-filling-assistance.md) |
