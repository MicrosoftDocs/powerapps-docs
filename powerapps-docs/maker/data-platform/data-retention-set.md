...
> However, there's an exception to this rule when long term retention, is being enabled through a solution import process. In such cases, the related child tables aren't automatically enabled.
