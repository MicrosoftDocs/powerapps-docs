...
> [!IMPORTANT]
> - The retention policy can not be set for the tables for which bulk delete is not supported. Example tables: Activity Pointer, Activity Party, Attachment. We are working to add validation for such tables. 
