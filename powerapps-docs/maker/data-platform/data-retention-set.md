...
|Table type  |Tables  |
|---------|---------|
|Standard     | Account, Contact, Case<sup>1</sup>, Opportunity<sup>1</sup>, Lead<sup>1</sup>, Quote<sup>1</sup>      |
|Activity  |  Activity Party, Activity Mime Attachment, Appointment, CampaignResponse<sup>1</sup>, Chat, Email, Fax, Letter, Phone Call, RecurringAppointmentMaster, ServiceAppointment<sup>1</sup>       |
