...
- A vitual table can't be on the *1* side of a 1:N (one-to-many) relationship. This is because virtual tables are just metadata representations of the source table. When you create a relationship, additional supporting columns are added to the 1 side of the 1:N relationship. Dataverse doesn't have the ability to create new columns in source systems.
