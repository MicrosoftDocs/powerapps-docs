...
- By default, the Microsoft Copilot Studio client for Dataverse MCP server is enabled for all environments. You must enable the additional clients in the Power Platform admin center before you can connect to the client.
