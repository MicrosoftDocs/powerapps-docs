...
| Export more than 2,000 tables via Azure Synapse Link or add more than 2,000 tables to Fabric link. |  If you're using Azure Synapse Link, work around this issue by creating two or more profiles that contain less than 2,000 tables. <br><br> Expect to select more than 2,000 tables in Fabric link and in an Azure Synapse Link profile in a future update.| 
