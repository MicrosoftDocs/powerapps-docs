...
- Instant flows (flows that use a manual trigger) cannot be moved into a solution after they've been created.  If you need to have an instant flow in a solution, it must be created in a solution originally.
