...
-	If you encounter a canvas app publishing error stating 'the app has connections to flows that are no longer in the environment', remove any deleted flows from the app. Then save and publish the app.  
