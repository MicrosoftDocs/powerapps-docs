...
- Flows using [connectors](https://docs.microsoft.com/connectors/connector-reference/) that are 'indexed' cannot be added into solutions. Indexing enables the quick retrieval of those flows to display in a menu or list. Indexed connectors: instant/button flows, Power Apps, Teams, SharePoint, Dynamics 365 Customer Voice, Microsoft Forms, legacy Dataverse connector, Dynamics 365, Excel Online, Microsoft Project, Azure IOT Central V2, and Project Online. To work around this either (1) create a new flow in a solution or (2) change the flow to remove the indexed connector usage, add it into a solution, and then change it back.
