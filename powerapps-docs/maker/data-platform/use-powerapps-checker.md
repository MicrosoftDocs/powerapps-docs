...
| Canvas App  | [app-formula-issues-high](https://learn.microsoft.com/powerapps/maker/canvas-apps/formula-reference)  | Refer to Power Apps formula references for additional details.  | Critical  | Design |
| Canvas App  | [app-formula-issues-medium](https://learn.microsoft.com/powerapps/maker/canvas-apps/formula-reference)  | Refer to Power Apps formula references for additional details.  |  Medium  | Design |
| Canvas App  | [app-formula-issues-low](https://learn.microsoft.com/powerapps/maker/canvas-apps/formula-reference)  | Refer to Power Apps formula references for additional details. |  Low  | Design |
| Canvas App  | [app-use-delayoutput-text-input](https://learn.microsoft.com/powerapps/maker/canvas-apps/performance-tips#use-delayed-load)  | Use delayed load in some scenarios to improve performance. |  Medium  | Performance |
| Canvas App  | [app-reduce-screen-controls](https://learn.microsoft.com/powerapps/maker/canvas-apps/performance-tips#limit-the-number-of-controls)  | Limit the number of app controls for improved performance.  |  Medium  | Performance |
