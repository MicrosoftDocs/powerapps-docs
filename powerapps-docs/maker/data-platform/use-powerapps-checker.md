...
|Plug-in or workflow activity  | [meta-license-fieldservice-sdkmessages](/dynamics365/field-service/license-compliance-overview#meta-license-fieldservice-sdkmessages)  |  Solution contains SDK messages and operations that require a valid Dynamics 365 Field Service license.   | Low | Licensing |
