...
|Web Resources  | [use-async](./powerapps-checker-docs/ESLint/rules/use-async.md)  |  Interact with HTTP and HTTPS resources asynchronously.   |
|Web Resources  | [avoid-modals](./powerapps-checker-docs/ESLint/rules/avoid-modals.md)  | Avoid using modal dialogs.   |
|Web Resources  | [avoid-dom-form](./powerapps-checker-docs/ESLint/rules/avoid-dom-form.md)  | |
|Web Resources  | [avoid-dom-form-event](./powerapps-checker-docs/ESLint/rules/avoid-dom-form-event.md)  | |
|Web Resources  | [avoid-crm2011-service-odata](./powerapps-checker-docs/ESLint/rules/avoid-crm2011-service-odata.md) | Don't target the Microsoft Dynamics CRM 2011 OData 2.0 endpoint.     |
|Web Resources  | [avoid-crm2011-service-soap](./powerapps-checker-docs/ESLint/rules/avoid-crm2011-service-soap.md)  | Don't target the Microsoft Dynamics CRM 2011 SOAP services.   |
|Web Resources  | [avoid-browser-specific-api](./powerapps-checker-docs/ESLint/rules/avoid-browser-specific-api.md) | Don't use Internet Explorer legacy APIs or browser plug-ins.   |
|Web Resources  | [avoid-unpub-api](./powerapps-checker-docs/ESLint/rules/avoid-unpub-api.md) |  |
|Web Resources  | [avoid-window-top](./powerapps-checker-docs/ESLint/rules/avoid-window-top.md) | |
|Web Resources  | [avoid-2011-api](./powerapps-checker-docs/ESLint/rules/avoid-2011-api.md)  | Don't use the deprecated Microsoft Dynamics CRM 2011 object model. Instead follow [Dataverse Web API](https://docs.microsoft.com/powerapps/developer/data-platform/webapi/overview) documentation. |
|Web Resources  | [use-relative-uri](./powerapps-checker-docs/ESLint/rules/use-relative-uri.md)   | Don't use absolute Dataverse endpoint URLs.    |
|Web Resources  | [use-cached-webresource](./powerapps-checker-docs/ESLint/rules/use-cached-webresource.md)   |  |
|Web Resources  | [use-client-context](./powerapps-checker-docs/ESLint/rules/use-client-context.md)  | Use client contexts.   |
|Web Resources  | [use-navigation-api](./powerapps-checker-docs/ESLint/rules/use-navigation-api.md)   | Use navigation API parameters.   |
|Web Resources  | [use-offline](./powerapps-checker-docs/ESLint/rules/use-offline.md)   |  |
|Web Resources  | [do-not-make-parent-assumption](./powerapps-checker-docs/ESLint/rules/do-not-make-parent-assumption.md)   |  |
|Web Resources  | [use-org-setting](./powerapps-checker-docs/ESLint/rules/use-org-setting.md)   | Use organization settings.   |
|Web Resources  | [use-global-context](./powerapps-checker-docs/ESLint/rules/use-global-context.md)   |  |
|Web Resources  | [use-grid-api](./powerapps-checker-docs/ESLint/rules/use-grid-api.md)   | Use the grid APIs.    |
|Web Resources  | [use-utility-dialogs](./powerapps-checker-docs/ESLint/rules/use-utility-dialogs.md)   |    |
|Web Resources  | [avoid-isActivityType](./powerapps-checker-docs/ESLint/rules/avoid-isactivitytype.md)   | Replace Xrm.Utility.isActivityType method with new Xrm.Utility.gettableMetadata and don't use in ribbon rules.    |
