...
When opening a Synapse Link profile, you may see an error with a message and link to this document https://aka.ms/SynapeLinkErrors. In addition, user may also see “Error” status next to tables that are already in a Synapse Link profile. You can use this troubleshooting guide to diagnose and fix error conditions.
...
| **CT-809**: Row version change tracking property disabled in Table. Data updates are paused | Synapse Link service requires enabling the “Row version change tracking” metadata property. This property is disabled for the table and the table is no longer updated. <br> Updating this metadata property in Finance and Operations requires developer intervention. It is possible that the property was disabled after the Synapse Link was profile created. | Re-enable the row version change tracking metadata property to resume this table. <br> You may need an administrator or the developer to re-enable the property using developer tools. See [documentation](https://learn.microsoft.com/dynamics365/fin-ops-core/dev-itpro/data-entities/rowversion-change-track#enable-row-version-change-tracking-for-tables) for details. | 
...
|**FnO-811**: Linked Finance and Operations environment needs to be updated | FnO environment linked to this Synapse Link profile needs to be updated to the latest version. <br> If you are currently on FnO versions PU60, PU61 or PU62 you need to take the latest cumulative updates <br> 10.0.36 (PU 60) - 7.0.7036.133 or Higher <br> 10.0.37 (PU 61) - 7.0.7068.109 or Higher <br> 10.0.38 (PU 62) - 7.0.7120.59 or Higher <br> required updates are included in cumulative updates 10.0.39 (PU63) | Contact your FnO administrator and apply the latest version updates to your FnO environment. |
|
