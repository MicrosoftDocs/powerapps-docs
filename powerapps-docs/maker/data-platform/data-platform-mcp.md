...
Once connected to the Dataverse MCP Server, you can choose from various tools in the Power Platform environment. This table describes the available tools, their descriptions, categorizations, API call types, feature names, metadata references, and associated Copilot credits.
