...
1. On the left navigation pane, select **Networking**.
   ...
   4. Add a new **IP firewall rule**, give it a name, Start IP, and End IP. Select Save when done. For more information: [Azure Synapse Analytics IP firewall rules](https://learn.microsoft.com/en-us/azure/synapse-analytics/security/synapse-workspace-ip-firewall#ip-firewall-rules)
