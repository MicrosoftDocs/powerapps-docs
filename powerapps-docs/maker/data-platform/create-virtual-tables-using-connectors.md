...
contributors: 
  ...
  - phecke 
---
# Create virtual tables using the Excel virtual connector provider (preview)

[!INCLUDE [cc-beta-prerelease-disclaimer](../../includes/cc-beta-prerelease-disclaimer.md)]

To create a virtual table that uses Excel as the data source, use the Excel virtual connector provider.
...
## Create a virtual table using a virtual connector provider for Excel

Creating a virtual table in Power Apps with the virtual connector provider includes the following steps:
