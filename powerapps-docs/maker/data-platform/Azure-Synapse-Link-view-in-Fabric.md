...
3.  Provide **Connection name** and the **Data source path**. You can obtain the connection name from the power platform Admin center. You must enter the **Environment URL** you get from admin center into both the fields. Remember to remove https:// and the trailing /
    ...
    ![Create a one time connection](media/Fabric/Fabric-launch-connections-and-gateways.png)
...
![A screenshot of a computer Description automatically generated](media/fe1cec93a4064e7dc73dd659ffac8420.png)
...
![A screenshot of a computer Description automatically generated with medium confidence](media/afaa7ec4c7e13dcb7bd65b556017f1c1.png)You can launch SQL endpoint and query Dataverse data with SQL and generate views in Microsoft Fabric.
...
![A screenshot of a computer Description automatically generated with medium confidence](media/debad6aec1c5938cf91adf6273f99cb6.png)
...
![A screenshot of a computer Description automatically generated with medium confidence](media/9e0051e24776e06f0aee25fcdbbce933.png)
...
1.  You can work with tables from One Lake in the maker portal. For this, choose SQL endpoint for the Synapse Lakehouse.
    ...
    2.  ![A screenshot of a computer Description automatically generated with medium confidence](media/b9ff77e402904617825c74fb3d5a46de.png)Copy the SQL connection string in the properties Windows as shown by (2)
1.  Launch PowerApps maker portal and select Tables. Choose **New table from external data**

![A screenshot of a computer Description automatically generated with medium confidence](media/61bcc512a23cd74d979ac48a4f962d5f.png)
