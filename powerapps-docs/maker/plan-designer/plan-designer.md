...
The **Objects** view is in preview, and several functions that are native to the solution view don't work in the embedded Plan designer experience. 
...
- After saving and exiting the row summary, users are redirected to the **All** section of **Objects** instead of their previous location.  
