...
In this scenario, two user roles are generated: the employee and the manager. Each user role includes a description and user needs. The user roles and needs appear in a bullet list on the left, while a visual diagram appears on the right.
