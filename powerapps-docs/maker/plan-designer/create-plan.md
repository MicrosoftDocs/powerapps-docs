...
In this scenario, two user roles are generated: the employee and the manager. Each user role includes a description and user needs. The user roles and needs appear in a bullet list and on the right you'll see a visual diagram.
...
1. Review the user roles and needs. Then, choose one of the following options:
    ...
    **Making edits**  
    ...
    1. Inline editing provides these options:
        ...
        a. Select a user role to modify it. 
