...
Open the Plan designer from the Power Apps home page. It guides you through a process to generate user roles, user stories, data tables, and user experiences.
...
1. Type your prompt in the text box, such as the example prompt shown below. Provide more context, like process diagrams, data models, or screenshots of legacy apps. When you're done, press **Enter**.
