...
In this scenario, two roles are generated: the employee and the manager. Each role includes a description and user needs. The user roles and needs appear in a bullet list on the left, while a visual diagram appears on the right.
...
1. To view details of the proposed technologies, hover over the **information icon**. The pop-up info card shows the user roles and data tables.
