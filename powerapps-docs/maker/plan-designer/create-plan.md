...
Use the [Plan designer](plan-designer.md) to create business solutions quickly. 
...
Review and refine the outputs generated by the agents.
...
1. Review the user roles and stories. Then choose one of the following options:
   ...
   - Select **Edit** to make edits inline or add new user roles or needs.
    ...
    :::image type="content" source="media/create-a-plan/image3.png" alt-text="Screenshot of the Plan designer showing user roles and stories. Options to edit or add roles are visible.":::
