---
title: Image set control for cards in Power Apps
description: Learn about the details, properties and examples of the image set control for cards in Power Apps.
author: anuitz
ms.topic: reference
ms.custom: 
ms.reviewer: mkaur
...
# Image set control for cards in Power Apps
