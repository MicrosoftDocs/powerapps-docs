...
1. To get started, sign in to [Power Apps](https://make.powerapps.com) and then select **Cards**. If the item isn’t in the left navigation pane, select **More** and then select the item you want.
