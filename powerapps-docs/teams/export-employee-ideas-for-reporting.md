...
1.  Install the Employee Ideas template app from <https://aka.ms/teamsemployeeideas>.
...
> NOTE: You can use Power BI to report directly on Dataverse for Teams; however, if you want to bring the data into a data lake to more easily combine it with other sources, exporting it may have advantages.
