...
|Capacity  |Up to 30M rows<br/>([considerations](/office365/servicedescriptions/sharepoint-online-service-description/sharepoint-online-limits) for lists > 100k)  |Up to 1M rows<br/><br/>Small number of files or images<br/><br/>For limits on API requests per day, please refer entitlements available for Microsoft 365 apps with Power Platform access here: [Request limits based on user licenses](/power-platform/admin/api-request-limits-allocations#request-limits-based-on-user-licenses)  | No specified limit on rows. <br/><br/>No specified limit of files or images.<br/><br/> For limits on API requests per day, with option of capacity add-ons, go to this article: [Request limits based on user licenses](/power-platform/admin/api-request-limits-allocations#request-limits-based-on-user-licenses)  |
