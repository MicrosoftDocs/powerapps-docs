...
1. Open the sample app (for example, **Manage Inspection**) in [Power Apps Studio](#open-sample-app-in-power-apps-studio).
...
1. Open the sample app (for example, **Inspection**) in [Power Apps Studio](#open-sample-app-in-power-apps-studio).
...
1. Open the **Inspection Manager** app in [Power Apps Studio](#open-sample-app-in-power-apps-studio).
