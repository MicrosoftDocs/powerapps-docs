...
description: Walkthrough of running a canvas-based app on a mobile device
services: ''
suite: powerapps
...
## Find your app
To make it easier to find your app, open the **PowerApps** menu, and then select a filter.
...
After you filter your apps, you can sort them by the date they were most recently opened or modified. These preferences are retained when you close and reopen PowerApps.

Add screenshot of sort menu

## Run your app
To run an canvas-driven app on a mobile device, tap the app icon, or tap the push notification that appears when someone shares an app with you.
