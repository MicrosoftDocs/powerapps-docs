...
You cannot reset controls that are within a [**Gallery**](../maker/controls/control-gallery.md) or [**Edit form**](../maker/controls/control-form-detail.md) control from outside those controls.  You can reset controls from formulas on controls within the same gallery or form.  You can also reset all the controls within a form with the [**ResetForm**](../maker/functions/function-form.md) function. 
