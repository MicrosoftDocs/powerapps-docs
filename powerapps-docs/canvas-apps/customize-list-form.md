...
**A:** Yes. You can [add and configure controls](add-configure-controls.md), [connect to available data sources](add-data-connection.md), or [add your own data sources](../canvas-apps/register-custom-api.md), just like you can with standalone apps.
