...
<li><b>entityId</b>: (Optional) String. ID of the entity record to display the form for. If you don't specify this value, it will open a blank entity record for you to creare a new one.</li>
