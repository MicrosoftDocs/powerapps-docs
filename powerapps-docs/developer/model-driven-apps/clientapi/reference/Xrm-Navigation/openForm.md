...
<li><b>openInNewWindow</b>: (Optional) Boolean. Indicates whether to display form in a new window or a new tab. If you specify <code>true</code> and do not specify values for height or width, the form will display in a new tab. A form is slower to open in a new window or a new tab versus the same tab; consider opening a form in a main form dialog instead.</li>
