...
> [!NOTE]
> Form contexts are only valid during the event where they're passed. [The same restrictions apply as with execution contexts](./clientapi-execution-context.md#common-mistakes-in-accessing-contexts).
