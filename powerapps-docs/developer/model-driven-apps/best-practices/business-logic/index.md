...
|[Disable NavBar when programmatically opening entity forms or views](disable-navbar-programmatically-opening-entity-forms-views.md)|Opening up entity forms or views with a URL, could lead to slower client performance on high latency networks when the navigation bar (NavBar) is enabled.|
