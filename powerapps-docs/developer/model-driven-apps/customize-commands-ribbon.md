...
## Community tool
The SDK describes the process of editing the ribbon by editing the customization.xml file directly. Use the [Ribbon Workbench](https://www.develop1.net/public/rwb/ribbonworkbench.aspx) community tool to easily edit ribbon. 
