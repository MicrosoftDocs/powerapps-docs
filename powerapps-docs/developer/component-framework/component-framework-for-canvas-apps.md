...
> [!WARNING]
> Custom components contains code t hat may not be generated by Microsoft and can potentially access tokens and data. Make sure that the custom component solutions are from trusted source.
