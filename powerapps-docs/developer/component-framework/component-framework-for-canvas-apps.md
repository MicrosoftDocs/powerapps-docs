...
<!--from editor: Note that this title does not match the TOC. -->
...
<!--from editor: I'm removing the number from this because you don't need it with only one item. -->
...
4. Select the **Code (experimental)** tab, add a component from the list, and then select **Import**. This adds the sample component in the **Components** menu.
