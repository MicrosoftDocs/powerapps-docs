...
<!--from editor: "Availability for canvas apps" doesn't match the title of the page that it opens. Should it? -->
...
<!--from editor: In the second sentence below, should it be "... same context, and load at ..."? -->
