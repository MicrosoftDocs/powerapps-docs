...
Power Apps component framework empowers professional developers and app makers to create code components for model-driven and canvas apps to provide an enhanced user experience for the users to work with data on forms, views, dashboards, and canvas apps screens. For example:
