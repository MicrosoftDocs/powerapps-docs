...
> [!IMPORTANT]
> The **Available for** tab shows which APIs are supported by model-driven apps and canvas apps. It is recommended to check the **Available for** section in each individual API whether it is supported or not.
