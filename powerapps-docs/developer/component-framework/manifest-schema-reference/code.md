...
|--|--|--|--|-----|
|`path`|Place where the resource files are located|`String`|Yes|Model-driven apps and canvas apps |
|`order`|The order in which the resource files should load|`Positive integer`|Yes|Model-driven apps and canvas apps |
