...
|`control-type`|Whether the control is a standard control or a React control. The value of `virtual` indicates a React control. React controls are a feature in public preview. More information: [React Controls & Platform Libraries Public Preview](../react-controls-platform-libraries.md)|[!INCLUDE [controltype-description](includes/controltype-description.md)]|No|Model-driven and canvas apps |
