...
<li>They can add Service Accounts to Dataverse, with a consent flow disclosing that the Service Account is being added , this generally requires <a href="https://learn.microsoft.com/en-us/azure/architecture/guide/resilience/azure-ad-secure-single-page-application">Single Page Application</a>, and in case of 1st parties, the consent is automatic.</li>
