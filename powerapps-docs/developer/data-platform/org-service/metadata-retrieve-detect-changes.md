...
[Sample: Query and detect table definitions changes](samples/query-metadata-changes.md)<br />
[Retrieve, update, and delete tables](metadata-retrieve-update-delete-entities.md)
