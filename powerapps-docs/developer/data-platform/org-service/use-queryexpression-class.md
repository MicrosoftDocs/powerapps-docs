---
title: "Use the QueryExpression class (Microsoft Dataverse) | Microsoft Docs"
description: "Use the QueryExpression class to build complex queries for use with the IOrganizationService.QueryBase method or the RetrieveMultipleRequest message."
ms.date: 02/09/2024
author: divkamath
ms.author: dikamath
ms.reviewer: pehecke
