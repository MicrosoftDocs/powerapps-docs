---
title: "Build queries with LINQ (.NET language-integrated query) (Microsoft Dataverse) | Microsoft Docs" 
description: "Learn how to use .NET Language-Integrated Query (LINQ) to write queries for Microsoft Dataverse." 
ms.date: 04/03/2022
author: MsSQLGirl
ms.author: jukoesma
ms.reviewer: pehecke
