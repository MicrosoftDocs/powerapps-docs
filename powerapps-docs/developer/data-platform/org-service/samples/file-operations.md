...
1. Open the `PowerApps-Samples\dataverse\orgsvc\C#-NETx\FileOperations\FileOperations.sln` file using Visual Studio 2022.
...
The code for each project is in the `Program.cs` file for each project:
...
Each project uses a shared `Utility` class to perform common operations. This code is in the [Utility.cs](https://github.com/microsoft/PowerApps-Samples/blob/master/dataverse/webapi/C%23-NETx/FileOperations/Utility.cs) file.
