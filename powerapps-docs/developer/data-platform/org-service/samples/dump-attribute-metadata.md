---
title: "Sample: Dump column definitions to a file (Microsoft Dataverse) | Microsoft Docs"
description: "This sample showcases how to dump column definitions to a file." 
ms.date: 04/03/2022
author: mkannapiran
ms.author: kamanick
ms.reviewer: jdaly
...
> [SDK for .NET: Dump column definitions information to a file sample code](https://github.com/microsoft/PowerApps-Samples/tree/master/dataverse/orgsvc/CSharp/DumpAttributeInfo)
