...
|-------------|-----------|-------|
|init|Initializes the code component project. It has the following parameters: <ul><li>*namespace*: Namespace of the code component. </li><li>*name*: Name of the code component.</li><li>*template*: `field` or `dataset`</li><li>*framework*: `react` Use this for the [React Controls & Platform Libraries Public Preview](../../../component-framework/react-controls-platform-libraries.md)</li></ul>| `pac pcf init --namespace SampleNameSpace --name SampleComponent --template field`|
