...
An Azure hybrid relay connection to Dataverse uses the REST contract. More information: [Use an Azure hybrid relay connection](azure-hybrid-relay-connection.md)
