...
1. Set configuration variables in your SPA with information from that registration.  
   ...
   - The Id of the Entra ID tenant your organization uses to authenticate.
