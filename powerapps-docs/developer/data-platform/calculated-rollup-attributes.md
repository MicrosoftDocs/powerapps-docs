...
## Rollup attributes  
 Because rollup attributes persist in the database, they can be used for filtering or sorting just like regular attributes. Any kind of process or plug-in will use the most recently calculated value of the attribute. Rollup attribute values are calculated asynchronously by scheduled system jobs. Administrators set when a job is run or pause the job. By default, each attribute is updated hourly. More information: [Define rollup fields](../../maker/data-platform/define-rollup-fields.md).  
...
### See also  
 ...
 [Define calculated fields](../../maker/data-platform/define-calculated-fields.md)   
 [Define rollup fields](../../maker/data-platform/define-rollup-fields.md)
