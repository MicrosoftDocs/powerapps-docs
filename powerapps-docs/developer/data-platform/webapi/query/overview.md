...
- For supported relationships for $expand see [Supported Relationship Types for $expand](../../webapi/query/join-tables.md#supported-relationship-types-for-expand)
