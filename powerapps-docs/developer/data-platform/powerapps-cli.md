...
|Command|Description|
|-------|-----------|
|[admin](#pack)|Commands for Environment Lifecycle features.|
...
|[package](#pack)|Commands for working with [Solution Packages](https://docs.microsoft.com/en-us/power-platform/alm/package-deployer-tool).|
