...
An administrator can assign a record to an Entra ID group.  The Entra ID group team is created into Dataverse automatically if it doesn't exist in Dataverse.
...
```
<!-- ## Share a record to an Entra ID group 

"An administrator or a record owner can share a record to an Entra ID group. The Entra ID group team is created into Dataverse automatically if it doesn't exist in Dataverse.
...
<!-- ## Share a record to an Entra ID group member

"An administrator or a record owner can share a record to an Entra ID group member. The Entra ID group member is added into Dataverse automatically if the user doesn't exist in Dataverse.
