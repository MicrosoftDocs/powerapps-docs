...
> [!NOTE]
> A compatibility issue has been found with the SQL Server Management Studio 18.9.2 build. A fix is being investigated. Until the fix is available please use build 18.9.1. Link to build [18.9.1 of SQL Server Management Studio](https://docs.microsoft.com/en-us/sql/ssms/release-notes-ssms?view=sql-server-ver15#1891)
