---
title: "msdyn_knowledgeassetconfiguration table/entity reference (Microsoft Dataverse) | Microsoft Docs"
description: "Includes schema information and supported messages for the msdyn_knowledgeassetconfiguration table/entity."
ms.date: 06/04/2024
...
# msdyn_knowledgeassetconfiguration table/entity reference
...
|-|-|-|
|Assign|PATCH /msdyn_knowledgeassetconfigurations(*msdyn_knowledgeassetconfigurationid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST /msdyn_knowledgeassetconfigurations<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|CreateMultiple||<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
|Delete|DELETE /msdyn_knowledgeassetconfigurations(*msdyn_knowledgeassetconfigurationid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref:Microsoft.Dynamics.CRM.GrantAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref:Microsoft.Dynamics.CRM.IsValidStateTransition?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref:Microsoft.Dynamics.CRM.ModifyAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET /msdyn_knowledgeassetconfigurations(*msdyn_knowledgeassetconfigurationid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET /msdyn_knowledgeassetconfigurations<br />See [Query Data](/powerapps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH /msdyn_knowledgeassetconfigurations(*msdyn_knowledgeassetconfigurationid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH /msdyn_knowledgeassetconfigurations(*msdyn_knowledgeassetconfigurationid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
- [msdyn_aipluginoperationidName](#BKMK_msdyn_aipluginoperationidName)
...
### <a name="BKMK_msdyn_aipluginoperationidName"></a> msdyn_aipluginoperationidName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_aipluginoperationidname|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|
...
Same as the [msdyn_knowledgeassetconfiguration_SyncErrors](syncerror.md#BKMK_msdyn_knowledgeassetconfiguration_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) table/entity.
...
Same as the [msdyn_knowledgeassetconfiguration_AsyncOperations](asyncoperation.md#BKMK_msdyn_knowledgeassetconfiguration_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) table/entity.
...
Same as the [msdyn_knowledgeassetconfiguration_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_knowledgeassetconfiguration_MailboxTrackingFolders) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) table/entity.
...
Same as the [msdyn_knowledgeassetconfiguration_ProcessSession](processsession.md#BKMK_msdyn_knowledgeassetconfiguration_ProcessSession) many-to-one relationship for the [processsession](processsession.md) table/entity.
...
Same as the [msdyn_knowledgeassetconfiguration_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_knowledgeassetconfiguration_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) table/entity.
...
Same as the [msdyn_knowledgeassetconfiguration_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_knowledgeassetconfiguration_PrincipalObjectAttributeAccesses) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) table/entity.
...
See the [lk_msdyn_knowledgeassetconfiguration_createdby](systemuser.md#BKMK_lk_msdyn_knowledgeassetconfiguration_createdby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.
...
See the [lk_msdyn_knowledgeassetconfiguration_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_knowledgeassetconfiguration_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_lk_msdyn_knowledgeassetconfiguration_modifiedby"></a> lk_msdyn_knowledgeassetconfiguration_modifiedby

**Added by**: System Solution Solution

See the [lk_msdyn_knowledgeassetconfiguration_modifiedby](systemuser.md#BKMK_lk_msdyn_knowledgeassetconfiguration_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.
...
See the [lk_msdyn_knowledgeassetconfiguration_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_knowledgeassetconfiguration_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_user_msdyn_knowledgeassetconfiguration"></a> user_msdyn_knowledgeassetconfiguration

**Added by**: System Solution Solution

See the [user_msdyn_knowledgeassetconfiguration](systemuser.md#BKMK_user_msdyn_knowledgeassetconfiguration) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_team_msdyn_knowledgeassetconfiguration"></a> team_msdyn_knowledgeassetconfiguration

**Added by**: System Solution Solution

See the [team_msdyn_knowledgeassetconfiguration](team.md#BKMK_team_msdyn_knowledgeassetconfiguration) one-to-many relationship for the [team](team.md) table/entity.

### <a name="BKMK_business_unit_msdyn_knowledgeassetconfiguration"></a> business_unit_msdyn_knowledgeassetconfiguration

**Added by**: System Solution Solution

See the [business_unit_msdyn_knowledgeassetconfiguration](businessunit.md#BKMK_business_unit_msdyn_knowledgeassetconfiguration) one-to-many relationship for the [businessunit](businessunit.md) table/entity.
...
See the [msdyn_knowledgeassetconfiguration_aipluginoperationid](aipluginoperation.md#BKMK_msdyn_knowledgeassetconfiguration_aipluginoperationid) one-to-many relationship for the [aipluginoperation](aipluginoperation.md) table/entity.
...
See the [msdyn_knowledgeassetconfiguration_customapiid](customapi.md#BKMK_msdyn_knowledgeassetconfiguration_customapiid) one-to-many relationship for the [customapi](customapi.md) table/entity.

### See also

[Dataverse table/entity reference](../about-entity-reference.md)  
[Web API Reference](/dynamics365/customer-engagement/web-api/about)  
<xref href="Microsoft.Dynamics.CRM.msdyn_knowledgeassetconfiguration?text=msdyn_knowledgeassetconfiguration EntityType" />