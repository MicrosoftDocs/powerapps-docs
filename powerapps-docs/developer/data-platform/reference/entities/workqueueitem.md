...
Same as the [workqueueitem_flowlog_workqueueitemid](flowlog.md#BKMK_workqueueitem_flowlog_workqueueitemid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
