...
|install|<xref:Microsoft.Dynamics.CRM.install?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|ListConnectionReferences|<xref:Microsoft.Dynamics.CRM.ListConnectionReferences?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|RunDesktopFlow|<xref:Microsoft.Dynamics.CRM.RunDesktopFlow?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|SaveAsDesktopFlow|<xref:Microsoft.Dynamics.CRM.SaveAsDesktopFlow?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
