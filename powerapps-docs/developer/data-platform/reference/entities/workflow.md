...
|-|-|-|
|AddRequiredDesktopFlowComponentsToSolutions||Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|CancelAllCloudFlowRuns||Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|install|<xref:Microsoft.Dynamics.CRM.install?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|ListConnectionReferences|<xref:Microsoft.Dynamics.CRM.ListConnectionReferences?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|RunDesktopFlow|<xref:Microsoft.Dynamics.CRM.RunDesktopFlow?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|SaveAsDesktopFlow|<xref:Microsoft.Dynamics.CRM.SaveAsDesktopFlow?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
- [licenseentitledbyName](#BKMK_licenseentitledbyName)
...
### <a name="BKMK_licenseentitledbyName"></a> licenseentitledbyName
...
- [Workflow_licenseentitledby](#BKMK_Workflow_licenseentitledby)
...
### <a name="BKMK_Workflow_licenseentitledby"></a> Workflow_licenseentitledby

**Added by**: Power Automate Workflow Table Extensions Solution

Same as the [Workflow_licenseentitledby](workflow.md#BKMK_Workflow_licenseentitledby) many-to-one relationship for the [workflow](workflow.md) table/entity.
...
Same as the [flowcapacityassignment_workflow](flowcapacityassignment.md#BKMK_flowcapacityassignment_workflow) many-to-one relationship for the [flowcapacityassignment](flowcapacityassignment.md) table/entity.
...
Same as the [flowevent_workflow](flowevent.md#BKMK_flowevent_workflow) many-to-one relationship for the [flowevent](flowevent.md) table/entity.
...
Same as the [workflow_flowlog_cloudflowid](flowlog.md#BKMK_workflow_flowlog_cloudflowid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
...
Same as the [workflow_flowlog_desktopflowid](flowlog.md#BKMK_workflow_flowlog_desktopflowid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
...
Same as the [AIPluginOperation_Workflow_Workflow](aipluginoperation.md#BKMK_AIPluginOperation_Workflow_Workflow) many-to-one relationship for the [aipluginoperation](aipluginoperation.md) table/entity.
...
Same as the [adx_invitation_redemptionworkflow](adx_invitation.md#BKMK_adx_invitation_redemptionworkflow) many-to-one relationship for the [adx_invitation](adx_invitation.md) table/entity.
...
See the [Workflow_licenseentitledby](workflow.md#BKMK_Workflow_licenseentitledby) one-to-many relationship for the [workflow](workflow.md) table/entity.
<a name="manytomany"></a>
...
IntersectEntityName: workflowcardconnections<br />
#### Table 1
