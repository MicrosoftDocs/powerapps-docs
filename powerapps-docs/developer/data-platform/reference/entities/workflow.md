...
|UpgradeDesktopFlowSchema|<xref href="Microsoft.Dynamics.CRM.UpgradeDesktopFlowSchema?text=UpgradeDesktopFlowSchema Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
