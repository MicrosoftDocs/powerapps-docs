...
Many-To-One Relationship: [deleteditemreference dataperformance_DeletedItemReferences](deleteditemreference.md#BKMK_dataperformance_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`dataperformance_DeletedItemReferences`|
|IsCustomizable|`True`|
