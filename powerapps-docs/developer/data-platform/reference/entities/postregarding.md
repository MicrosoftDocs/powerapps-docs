...
Many-To-One Relationship: [deleteditemreference postregarding_DeletedItemReferences](deleteditemreference.md#BKMK_postregarding_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`postregarding_DeletedItemReferences`|
|IsCustomizable|`True`|
