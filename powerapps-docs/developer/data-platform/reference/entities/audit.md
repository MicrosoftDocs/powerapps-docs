...
Many-To-One Relationship: [deleteditemreference audit_DeletedItemReferences](deleteditemreference.md#BKMK_audit_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`audit_DeletedItemReferences`|
|IsCustomizable|`True`|
