...
# EntityRefreshHistory (msdyn_entityrefreshhistory) table/entity reference (Microsoft Dataverse)
...
Many-To-One Relationship: [deleteditemreference msdyn_entityrefreshhistory_DeletedItemReferences](deleteditemreference.md#BKMK_msdyn_entityrefreshhistory_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`msdyn_entityrefreshhistory_DeletedItemReferences`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
