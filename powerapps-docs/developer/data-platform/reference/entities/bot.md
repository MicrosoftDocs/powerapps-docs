...
|PvaAuthorize|<xref:Microsoft.Dynamics.CRM.PvaAuthorize?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaAuthorize|
|PvaCreateBotComponents|<xref:Microsoft.Dynamics.CRM.PvaCreateBotComponents?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaCreateBotComponents|
|PvaCreateContentSnapshot|<xref:Microsoft.Dynamics.CRM.PvaCreateContentSnapshot?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaCreateContentSnapshot|
|PvaDeleteBot|<xref:Microsoft.Dynamics.CRM.PvaDeleteBot?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaDeleteBot|
|PvaGetDirectLineEndpoint|<xref:Microsoft.Dynamics.CRM.PvaGetDirectLineEndpoint?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaGetDirectLineEndpoint|
|PvaPublish|<xref:Microsoft.Dynamics.CRM.PvaPublish?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaPublish|
|PvaPublishStatus|<xref:Microsoft.Dynamics.CRM.PvaPublishStatus?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = PvaPublishStatus|
