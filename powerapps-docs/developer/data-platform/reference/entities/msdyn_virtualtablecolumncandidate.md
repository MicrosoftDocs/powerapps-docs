---
title: "Virtual Table Column Candidate (msdyn_virtualtablecolumncandidate) table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the Virtual Table Column Candidate (msdyn_virtualtablecolumncandidate) table/entity with Microsoft Dataverse."
...
# Virtual Table Column Candidate (msdyn_virtualtablecolumncandidate) table/entity reference (Microsoft Dataverse)
...
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `Create`<br />Event: True |`POST` /msdyn_virtualtablecolumncandidates<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_virtualtablecolumncandidates<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_virtualtablecolumncandidates(*msdyn_virtualtablecolumncandidateid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Virtual Table Column Candidate (msdyn_virtualtablecolumncandidate) table.
...
The following table lists selected properties for the Virtual Table Column Candidate (msdyn_virtualtablecolumncandidate) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_virtualtablecolumncandidate_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_virtualtablecolumncandidate_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_virtualtablecolumncandidate](businessunit.md#BKMK_business_unit_msdyn_virtualtablecolumncandidate)
...
One-To-Many Relationship: [systemuser lk_msdyn_virtualtablecolumncandidate_createdby](systemuser.md#BKMK_lk_msdyn_virtualtablecolumncandidate_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_virtualtablecolumncandidate_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_virtualtablecolumncandidate_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_virtualtablecolumncandidate_modifiedby](systemuser.md#BKMK_lk_msdyn_virtualtablecolumncandidate_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_virtualtablecolumncandidate_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_virtualtablecolumncandidate_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_virtualtablecolumncandidate](owner.md#BKMK_owner_msdyn_virtualtablecolumncandidate)
...
One-To-Many Relationship: [team team_msdyn_virtualtablecolumncandidate](team.md#BKMK_team_msdyn_virtualtablecolumncandidate)
...
One-To-Many Relationship: [systemuser user_msdyn_virtualtablecolumncandidate](systemuser.md#BKMK_user_msdyn_virtualtablecolumncandidate)
...
Many-To-One Relationship: [asyncoperation msdyn_virtualtablecolumncandidate_AsyncOperations](asyncoperation.md#BKMK_msdyn_virtualtablecolumncandidate_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_virtualtablecolumncandidate_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_virtualtablecolumncandidate_BulkDeleteFailures)
...
Many-To-One Relationship: [deleteditemreference msdyn_virtualtablecolumncandidate_DeletedItemReferences](deleteditemreference.md#BKMK_msdyn_virtualtablecolumncandidate_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`msdyn_virtualtablecolumncandidate_DeletedItemReferences`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [duplicaterecord msdyn_virtualtablecolumncandidate_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_virtualtablecolumncandidate_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_virtualtablecolumncandidate_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_virtualtablecolumncandidate_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_virtualtablecolumncandidate_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_virtualtablecolumncandidate_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_virtualtablecolumncandidate_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_virtualtablecolumncandidate_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_virtualtablecolumncandidate_ProcessSession](processsession.md#BKMK_msdyn_virtualtablecolumncandidate_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_virtualtablecolumncandidate_SyncErrors](syncerror.md#BKMK_msdyn_virtualtablecolumncandidate_SyncErrors)
