...
|BatchPrediction|<xref:Microsoft.Dynamics.CRM.BatchPrediction?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|Predict|<xref:Microsoft.Dynamics.CRM.Predict?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|PredictByReference|<xref:Microsoft.Dynamics.CRM.PredictByReference?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|PredictionSchema|<xref:Microsoft.Dynamics.CRM.PredictionSchema?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
Relationship details provided where the msdyn_AIModel table is the first table in the relationship. Listed by **SchemaName**.


### <a name="BKMK_botcomponent_msdyn_aimodel"></a> botcomponent_msdyn_aimodel

See the [botcomponent_msdyn_aimodel](botcomponent.md#BKMK_botcomponent_msdyn_aimodel) many-to-many relationship for the [botcomponent](botcomponent.md) table/entity.
