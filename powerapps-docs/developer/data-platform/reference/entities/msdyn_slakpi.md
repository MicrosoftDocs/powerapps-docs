---
title: "SLA KPI (msdyn_slakpi) table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the SLA KPI (msdyn_slakpi) table/entity with Microsoft Dataverse."
...
# SLA KPI (msdyn_slakpi) table/entity reference (Microsoft Dataverse)



## Messages

The following table lists the messages for the SLA KPI (msdyn_slakpi) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_slakpis(*msdyn_slakpiid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `Create`<br />Event: True |`POST` /msdyn_slakpis<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_slakpis(*msdyn_slakpiid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_slakpis(*msdyn_slakpiid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_slakpis<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_slakpis(*msdyn_slakpiid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_slakpis(*msdyn_slakpiid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_slakpis(*msdyn_slakpiid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|

## Properties

The following table lists selected properties for the SLA KPI (msdyn_slakpi) table.
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`slakpi_msdyn_advancedpauseconfiguration`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_slakpi_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_slakpi_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_slakpi](businessunit.md#BKMK_business_unit_msdyn_slakpi)
...
One-To-Many Relationship: [systemuser lk_msdyn_slakpi_createdby](systemuser.md#BKMK_lk_msdyn_slakpi_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_slakpi_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_slakpi_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_slakpi_modifiedby](systemuser.md#BKMK_lk_msdyn_slakpi_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_slakpi_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_slakpi_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_slakpi](owner.md#BKMK_owner_msdyn_slakpi)
...
One-To-Many Relationship: [team team_msdyn_slakpi](team.md#BKMK_team_msdyn_slakpi)
...
One-To-Many Relationship: [systemuser user_msdyn_slakpi](systemuser.md#BKMK_user_msdyn_slakpi)
...
Many-To-One Relationship: [slaitem msdyn_msdyn_slakpi_slaitem](slaitem.md#BKMK_msdyn_msdyn_slakpi_slaitem)
...
Many-To-One Relationship: [asyncoperation msdyn_slakpi_AsyncOperations](asyncoperation.md#BKMK_msdyn_slakpi_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_slakpi_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_slakpi_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_slakpi_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_slakpi_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_slakpi_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_slakpi_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_slakpi_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_slakpi_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_slakpi_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_slakpi_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_slakpi_ProcessSession](processsession.md#BKMK_msdyn_slakpi_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_slakpi_SyncErrors](syncerror.md#BKMK_msdyn_slakpi_SyncErrors)
...
<xref:Microsoft.Dynamics.CRM.msdyn_slakpi?displayProperty=fullName>
