...
# External Identity (adx_externalidentity) table/entity reference (Microsoft Dataverse)
...
| `Create`<br />Event: True |`POST` /adx_externalidentities<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
...
| `Update`<br />Event: True |`PATCH` /adx_externalidentities(*adx_externalidentityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /adx_externalidentities(*adx_externalidentityid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the External Identity (adx_externalidentity) table.
...
The following table lists selected properties for the External Identity (adx_externalidentity) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`adx_externalidentity_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`adx_externalidentity_statuscode`|
...
One-To-Many Relationship: [contact adx_contact_externalidentity](contact.md#BKMK_adx_contact_externalidentity)
...
One-To-Many Relationship: [systemuser lk_adx_externalidentity_createdby](systemuser.md#BKMK_lk_adx_externalidentity_createdby)
...
One-To-Many Relationship: [systemuser lk_adx_externalidentity_createdonbehalfby](systemuser.md#BKMK_lk_adx_externalidentity_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_adx_externalidentity_modifiedby](systemuser.md#BKMK_lk_adx_externalidentity_modifiedby)
...
One-To-Many Relationship: [systemuser lk_adx_externalidentity_modifiedonbehalfby](systemuser.md#BKMK_lk_adx_externalidentity_modifiedonbehalfby)
...
One-To-Many Relationship: [organization organization_adx_externalidentity](organization.md#BKMK_organization_adx_externalidentity)
...
Many-To-One Relationship: [asyncoperation adx_externalidentity_AsyncOperations](asyncoperation.md#BKMK_adx_externalidentity_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure adx_externalidentity_BulkDeleteFailures](bulkdeletefailure.md#BKMK_adx_externalidentity_BulkDeleteFailures)
...
Many-To-One Relationship: [mailboxtrackingfolder adx_externalidentity_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_adx_externalidentity_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess adx_externalidentity_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_adx_externalidentity_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession adx_externalidentity_ProcessSession](processsession.md#BKMK_adx_externalidentity_ProcessSession)
...
Many-To-One Relationship: [syncerror adx_externalidentity_SyncErrors](syncerror.md#BKMK_adx_externalidentity_SyncErrors)
