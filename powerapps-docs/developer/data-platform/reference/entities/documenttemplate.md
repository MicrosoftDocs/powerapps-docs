...
Many-To-One Relationship: [deleteditemreference documenttemplate_DeletedItemReferences](deleteditemreference.md#BKMK_documenttemplate_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`documenttemplate_DeletedItemReferences`|
|IsCustomizable|`True`|
