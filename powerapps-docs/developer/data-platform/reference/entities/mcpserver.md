...
# MCPServer table/entity reference (Microsoft Dataverse)

MCPServers component

## Messages

The following table lists the messages for the MCPServer table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /mcpservers(*mcpserverid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `Create`<br />Event: True |`POST` /mcpservers<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /mcpservers(*mcpserverid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /mcpservers(*mcpserverid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /mcpservers<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /mcpservers(*mcpserverid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /mcpservers(*mcpserverid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /mcpservers(*mcpserverid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|

## Properties

The following table lists selected properties for the MCPServer table.

|Property|Value|
| --- | --- |
| **DisplayName** | **MCPServer** |
| **DisplayCollectionName** | **MCPServers** |
| **SchemaName** | `MCPServer` |
| **CollectionSchemaName** | `MCPServers` |
| **EntitySetName** | `mcpservers`|
| **LogicalName** | `mcpserver` |
| **LogicalCollectionName** | `mcpservers` |
| **PrimaryIdAttribute** | `mcpserverid` |
...
|Property|Value|
|---|---|
|Description|**Audience associated with the MCP Server.**|
|DisplayName|**Audience**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`audience`|
|RequiredLevel|None|
|Type|String|
|Format|Text|
|FormatName|Text|
...
|Property|Value|
|---|---|
|Description|**Configurations for the MCP Server**|
...
|Property|Value|
|---|---|
|Description|**DisplayName of the MCP Server**|
...
### <a name="BKMK_Instructions"></a> Instructions
...
### <a name="BKMK_IsRemote"></a> IsRemote

|Property|Value|
|---|---|
|Description|**Denotes if this MCP server proxies another remote MCP server or not**|
|DisplayName|**Is Remote**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`isremote`|
|RequiredLevel|ApplicationRequired|
|Type|Boolean|
|GlobalChoiceName|`mcpserver_isremote`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Property|Value|
|---|---|
|Description|**Scopes needed for the MCP Server.**|
|DisplayName|**Scope**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`scope`|
...
|Property|Value|
|---|---|
|Description|**Status of the MCPServer**|
|DisplayName|**Status**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`mcpserver_statecode`|
...
|Property|Value|
|---|---|
|Description|**Reason for the status of the MCPServer**|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`mcpserver_statuscode`|
...
- [Icon_Timestamp](#BKMK_Icon_Timestamp)
- [Icon_URL](#BKMK_Icon_URL)
- [IconId](#BKMK_IconId)
...
### <a name="BKMK_Icon_Timestamp"></a> Icon_Timestamp
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|`icon_timestamp`|
|RequiredLevel|None|
|Type|BigInt|
|MaxValue|9223372036854775807|
|MinValue|-9223372036854775808|

### <a name="BKMK_Icon_URL"></a> Icon_URL
...
- [lk_mcpserver_createdby](#BKMK_lk_mcpserver_createdby)
...
One-To-Many Relationship: [businessunit business_unit_mcpserver](businessunit.md#BKMK_business_unit_mcpserver)
...
### <a name="BKMK_lk_mcpserver_createdby"></a> lk_mcpserver_createdby

One-To-Many Relationship: [systemuser lk_mcpserver_createdby](systemuser.md#BKMK_lk_mcpserver_createdby)
...
### <a name="BKMK_lk_mcpserver_createdonbehalfby"></a> lk_mcpserver_createdonbehalfby

One-To-Many Relationship: [systemuser lk_mcpserver_createdonbehalfby](systemuser.md#BKMK_lk_mcpserver_createdonbehalfby)
...
### <a name="BKMK_lk_mcpserver_modifiedby"></a> lk_mcpserver_modifiedby

One-To-Many Relationship: [systemuser lk_mcpserver_modifiedby](systemuser.md#BKMK_lk_mcpserver_modifiedby)
...
### <a name="BKMK_lk_mcpserver_modifiedonbehalfby"></a> lk_mcpserver_modifiedonbehalfby

One-To-Many Relationship: [systemuser lk_mcpserver_modifiedonbehalfby](systemuser.md#BKMK_lk_mcpserver_modifiedonbehalfby)
...
One-To-Many Relationship: [team team_mcpserver](team.md#BKMK_team_mcpserver)
...
### <a name="BKMK_user_mcpserver"></a> user_mcpserver

One-To-Many Relationship: [systemuser user_mcpserver](systemuser.md#BKMK_user_mcpserver)
...
Many-To-One Relationship: [asyncoperation mcpserver_AsyncOperations](asyncoperation.md#BKMK_mcpserver_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_AsyncOperations`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mcpserver_BulkDeleteFailures"></a> mcpserver_BulkDeleteFailures

Many-To-One Relationship: [bulkdeletefailure mcpserver_BulkDeleteFailures](bulkdeletefailure.md#BKMK_mcpserver_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mcpserver_MailboxTrackingFolders"></a> mcpserver_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder mcpserver_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_mcpserver_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mcpserver_PrincipalObjectAttributeAccesses"></a> mcpserver_PrincipalObjectAttributeAccesses

Many-To-One Relationship: [principalobjectattributeaccess mcpserver_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_mcpserver_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mcpserver_ProcessSession"></a> mcpserver_ProcessSession

Many-To-One Relationship: [processsession mcpserver_ProcessSession](processsession.md#BKMK_mcpserver_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mcpserver_SyncErrors"></a> mcpserver_SyncErrors

Many-To-One Relationship: [syncerror mcpserver_SyncErrors](syncerror.md#BKMK_mcpserver_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mcpserver_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_MCPTool_MCPServer_MCPServer"></a> MCPTool_MCPServer_MCPServer

Many-To-One Relationship: [mcptool MCPTool_MCPServer_MCPServer](mcptool.md#BKMK_MCPTool_MCPServer_MCPServer)

|Property|Value|
|---|---|
|ReferencingEntity|`mcptool`|
|ReferencingAttribute|`mcpserverid`|
|ReferencedEntityNavigationPropertyName|`MCPTool_MCPServer_MCPServer`|
|IsCustomizable|`False`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
