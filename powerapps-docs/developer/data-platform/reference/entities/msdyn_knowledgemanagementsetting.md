...
The following table lists the messages for the Knowledge Management Setting (msdyn_knowledgemanagementsetting) table.
...
| `Retrieve`<br />Event: True |`GET` /msdyn_knowledgemanagementsettings(*msdyn_knowledgemanagementsettingid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_knowledgemanagementsettings<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_knowledgemanagementsettings(*msdyn_knowledgemanagementsettingid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_knowledgemanagementsettings(*msdyn_knowledgemanagementsettingid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_knowledgemanagementsettings(*msdyn_knowledgemanagementsettingid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|

## Properties

The following table lists selected properties for the Knowledge Management Setting (msdyn_knowledgemanagementsetting) table.
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_knowledgemanagementsetting_msdyn_isautosuggestionsenabled`|
|DefaultValue|False|
|True Label|True|
|False Label|False|
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_knowledgemanagementsetting_msdyn_showcontextualactions`|
|DefaultValue|True|
|True Label|Show All|
|False Label|Show Selected Actions|
...
|Type|Picklist|
|DefaultFormValue|0|
|GlobalChoiceName|`msdyn_knowledgemanagementsetting_msdyn_status`|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_knowledgemanagementsetting_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_knowledgemanagementsetting_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_knowledgemanagementsetting](businessunit.md#BKMK_business_unit_msdyn_knowledgemanagementsetting)
...
One-To-Many Relationship: [systemuser lk_msdyn_knowledgemanagementsetting_createdby](systemuser.md#BKMK_lk_msdyn_knowledgemanagementsetting_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_knowledgemanagementsetting_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_knowledgemanagementsetting_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_knowledgemanagementsetting_modifiedby](systemuser.md#BKMK_lk_msdyn_knowledgemanagementsetting_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_knowledgemanagementsetting_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_knowledgemanagementsetting_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_knowledgemanagementsetting](owner.md#BKMK_owner_msdyn_knowledgemanagementsetting)
...
One-To-Many Relationship: [team team_msdyn_knowledgemanagementsetting](team.md#BKMK_team_msdyn_knowledgemanagementsetting)
...
One-To-Many Relationship: [systemuser user_msdyn_knowledgemanagementsetting](systemuser.md#BKMK_user_msdyn_knowledgemanagementsetting)
...
Many-To-One Relationship: [asyncoperation msdyn_knowledgemanagementsetting_AsyncOperations](asyncoperation.md#BKMK_msdyn_knowledgemanagementsetting_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_knowledgemanagementsetting_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_knowledgemanagementsetting_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_knowledgemanagementsetting_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_knowledgemanagementsetting_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_knowledgemanagementsetting_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_knowledgemanagementsetting_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_knowledgemanagementsetting_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_knowledgemanagementsetting_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_knowledgemanagementsetting_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_knowledgemanagementsetting_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_knowledgemanagementsetting_ProcessSession](processsession.md#BKMK_msdyn_knowledgemanagementsetting_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_knowledgemanagementsetting_SyncErrors](syncerror.md#BKMK_msdyn_knowledgemanagementsetting_SyncErrors)
