...
Many-To-One Relationship: [deleteditemreference actioncarduserstate_DeletedItemReferences](deleteditemreference.md#BKMK_actioncarduserstate_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`actioncarduserstate_DeletedItemReferences`|
|IsCustomizable|`True`|
