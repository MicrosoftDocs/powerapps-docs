...
Many-To-One Relationship: [deleteditemreference postfollow_DeletedItemReferences](deleteditemreference.md#BKMK_postfollow_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`postfollow_DeletedItemReferences`|
|IsCustomizable|`True`|
