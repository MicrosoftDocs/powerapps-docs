...
|CancelTraining|<xref:Microsoft.Dynamics.CRM.CancelTraining?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|PublishAIConfiguration|<xref:Microsoft.Dynamics.CRM.PublishAIConfiguration?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|PurgeRetainedContent|This message is to be executed only by Dataverse to trigger registered plug-ins and flows.||
|QuickTest|<xref:Microsoft.Dynamics.CRM.QuickTest?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|ScheduleTraining|<xref:Microsoft.Dynamics.CRM.ScheduleTraining?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|Train|<xref:Microsoft.Dynamics.CRM.Train?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|UnpublishAIConfiguration|<xref:Microsoft.Dynamics.CRM.UnpublishAIConfiguration?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|UnscheduleTraining|<xref:Microsoft.Dynamics.CRM.UnscheduleTraining?displayProperty=nameWithType />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
