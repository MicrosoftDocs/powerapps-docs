...
|CreateFlowCredentialApplication||Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|DeleteFlowMachineGroup|<xref:Microsoft.Dynamics.CRM.DeleteFlowMachineGroup?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|GetPublicKey|<xref:Microsoft.Dynamics.CRM.GetPublicKey?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|RotateGroupKey|<xref:Microsoft.Dynamics.CRM.RotateGroupKey?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|UpdateAccountCredentials|<xref:Microsoft.Dynamics.CRM.UpdateAccountCredentials?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
Same as the [flowevent_flowmachinegroup](flowevent.md#BKMK_flowevent_flowmachinegroup) many-to-one relationship for the [flowevent](flowevent.md) table/entity.
...
Same as the [flowcredentialapplication_flowmachinegroup](flowcredentialapplication.md#BKMK_flowcredentialapplication_flowmachinegroup) many-to-one relationship for the [flowcredentialapplication](flowcredentialapplication.md) table/entity.
...
|AssociatedMenuConfiguration|Behavior: UseCollectionName<br />Group: Details<br />Label: <br />Order: 10000|
|CascadeConfiguration|Assign: Cascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: Cascade|
...
Same as the [flowmachinegroup_flowlog_flowmachinegroupid](flowlog.md#BKMK_flowmachinegroup_flowlog_flowmachinegroupid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
