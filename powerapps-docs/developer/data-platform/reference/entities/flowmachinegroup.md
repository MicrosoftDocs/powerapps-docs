...
|GetPublicKey|<xref href="Microsoft.Dynamics.CRM.GetPublicKey?text=GetPublicKey Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
