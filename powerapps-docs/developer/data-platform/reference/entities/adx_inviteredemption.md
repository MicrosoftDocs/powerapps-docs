...
|-|-|-|
|Assign|PATCH /adx_inviteredemptions(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|BulkRetain|This message is to be executed only by Dataverse to trigger registered plug-ins and flows.||
|Create|POST /adx_inviteredemptions<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|CreateMultiple||<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
|Delete|DELETE /adx_inviteredemptions(*activityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|Retrieve|GET /adx_inviteredemptions(*activityid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET /adx_inviteredemptions<br />See [Query Data](/powerapps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|RollbackRetain|This message is to be executed only by Dataverse to trigger registered plug-ins and flows.||
|SetState|PATCH /adx_inviteredemptions(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH /adx_inviteredemptions(*activityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [adx_inviteredemption_activity_parties](activityparty.md#BKMK_adx_inviteredemption_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) table/entity.
...
Same as the [adx_inviteredemption_ActionCards](actioncard.md#BKMK_adx_inviteredemption_ActionCards) many-to-one relationship for the [actioncard](actioncard.md) table/entity.
...
Same as the [adx_inviteredemption_SyncErrors](syncerror.md#BKMK_adx_inviteredemption_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) table/entity.
...
Same as the [adx_inviteredemption_DuplicateMatchingRecord](duplicaterecord.md#BKMK_adx_inviteredemption_DuplicateMatchingRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) table/entity.
...
Same as the [adx_inviteredemption_DuplicateBaseRecord](duplicaterecord.md#BKMK_adx_inviteredemption_DuplicateBaseRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) table/entity.
...
Same as the [adx_inviteredemption_AsyncOperations](asyncoperation.md#BKMK_adx_inviteredemption_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) table/entity.
...
Same as the [adx_inviteredemption_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_adx_inviteredemption_MailboxTrackingFolders) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) table/entity.
...
Same as the [adx_inviteredemption_ProcessSession](processsession.md#BKMK_adx_inviteredemption_ProcessSession) many-to-one relationship for the [processsession](processsession.md) table/entity.
...
Same as the [adx_inviteredemption_BulkDeleteFailures](bulkdeletefailure.md#BKMK_adx_inviteredemption_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) table/entity.
...
Same as the [adx_inviteredemption_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_adx_inviteredemption_PrincipalObjectAttributeAccesses) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) table/entity.
...
Same as the [adx_inviteredemption_connections1](connection.md#BKMK_adx_inviteredemption_connections1) many-to-one relationship for the [connection](connection.md) table/entity.
...
Same as the [adx_inviteredemption_connections2](connection.md#BKMK_adx_inviteredemption_connections2) many-to-one relationship for the [connection](connection.md) table/entity.
...
Same as the [adx_inviteredemption_QueueItems](queueitem.md#BKMK_adx_inviteredemption_QueueItems) many-to-one relationship for the [queueitem](queueitem.md) table/entity.
...
Same as the [adx_inviteredemption_Annotations](annotation.md#BKMK_adx_inviteredemption_Annotations) many-to-one relationship for the [annotation](annotation.md) table/entity.
...
See the [knowledgebaserecord_adx_inviteredemptions](knowledgebaserecord.md#BKMK_knowledgebaserecord_adx_inviteredemptions) one-to-many relationship for the [knowledgebaserecord](knowledgebaserecord.md) table/entity.

### <a name="BKMK_account_adx_inviteredemptions"></a> account_adx_inviteredemptions

**Added by**: System Solution Solution

See the [account_adx_inviteredemptions](account.md#BKMK_account_adx_inviteredemptions) one-to-many relationship for the [account](account.md) table/entity.

### <a name="BKMK_adx_inviteredemption_systemuser_createdby"></a> adx_inviteredemption_systemuser_createdby

**Added by**: System Solution Solution

See the [adx_inviteredemption_systemuser_createdby](systemuser.md#BKMK_adx_inviteredemption_systemuser_createdby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_contact_adx_inviteredemptions"></a> contact_adx_inviteredemptions

**Added by**: System Solution Solution

See the [contact_adx_inviteredemptions](contact.md#BKMK_contact_adx_inviteredemptions) one-to-many relationship for the [contact](contact.md) table/entity.

### <a name="BKMK_adx_inviteredemption_mailbox_sendermailboxid"></a> adx_inviteredemption_mailbox_sendermailboxid

**Added by**: System Solution Solution

See the [adx_inviteredemption_mailbox_sendermailboxid](mailbox.md#BKMK_adx_inviteredemption_mailbox_sendermailboxid) one-to-many relationship for the [mailbox](mailbox.md) table/entity.
...
See the [adx_inviteredemption_transactioncurrency_transactioncurrencyid](transactioncurrency.md#BKMK_adx_inviteredemption_transactioncurrency_transactioncurrencyid) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) table/entity.

### <a name="BKMK_adx_inviteredemption_systemuser_owninguser"></a> adx_inviteredemption_systemuser_owninguser

**Added by**: System Solution Solution

See the [adx_inviteredemption_systemuser_owninguser](systemuser.md#BKMK_adx_inviteredemption_systemuser_owninguser) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_adx_inviteredemption_sla_slaid"></a> adx_inviteredemption_sla_slaid

**Added by**: System Solution Solution

See the [adx_inviteredemption_sla_slaid](sla.md#BKMK_adx_inviteredemption_sla_slaid) one-to-many relationship for the [sla](sla.md) table/entity.

### <a name="BKMK_adx_inviteredemption_businessunit_owningbusinessunit"></a> adx_inviteredemption_businessunit_owningbusinessunit

**Added by**: System Solution Solution

See the [adx_inviteredemption_businessunit_owningbusinessunit](businessunit.md#BKMK_adx_inviteredemption_businessunit_owningbusinessunit) one-to-many relationship for the [businessunit](businessunit.md) table/entity.

### <a name="BKMK_knowledgearticle_adx_inviteredemptions"></a> knowledgearticle_adx_inviteredemptions

**Added by**: System Solution Solution

See the [knowledgearticle_adx_inviteredemptions](knowledgearticle.md#BKMK_knowledgearticle_adx_inviteredemptions) one-to-many relationship for the [knowledgearticle](knowledgearticle.md) table/entity.

### <a name="BKMK_adx_inviteredemption_systemuser_modifiedonbehalfby"></a> adx_inviteredemption_systemuser_modifiedonbehalfby

**Added by**: System Solution Solution

See the [adx_inviteredemption_systemuser_modifiedonbehalfby](systemuser.md#BKMK_adx_inviteredemption_systemuser_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_adx_inviteredemption_systemuser_createdonbehalfby"></a> adx_inviteredemption_systemuser_createdonbehalfby

**Added by**: System Solution Solution

See the [adx_inviteredemption_systemuser_createdonbehalfby](systemuser.md#BKMK_adx_inviteredemption_systemuser_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_adx_inviteredemption_systemuser_modifiedby"></a> adx_inviteredemption_systemuser_modifiedby

**Added by**: System Solution Solution

See the [adx_inviteredemption_systemuser_modifiedby](systemuser.md#BKMK_adx_inviteredemption_systemuser_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_adx_inviteredemption_team_owningteam"></a> adx_inviteredemption_team_owningteam

**Added by**: System Solution Solution

See the [adx_inviteredemption_team_owningteam](team.md#BKMK_adx_inviteredemption_team_owningteam) one-to-many relationship for the [team](team.md) table/entity.

### <a name="BKMK_adx_inviteredemption_sla_slainvokedid"></a> adx_inviteredemption_sla_slainvokedid

**Added by**: System Solution Solution

See the [adx_inviteredemption_sla_slainvokedid](sla.md#BKMK_adx_inviteredemption_sla_slainvokedid) one-to-many relationship for the [sla](sla.md) table/entity.

### <a name="BKMK_activity_pointer_adx_inviteredemption"></a> activity_pointer_adx_inviteredemption

**Added by**: System Solution Solution

See the [activity_pointer_adx_inviteredemption](activitypointer.md#BKMK_activity_pointer_adx_inviteredemption) one-to-many relationship for the [activitypointer](activitypointer.md) table/entity.

### <a name="BKMK_mspp_adplacement_adx_inviteredemptions"></a> mspp_adplacement_adx_inviteredemptions

**Added by**: Power Pages Apps Solution

See the [mspp_adplacement_adx_inviteredemptions](mspp_adplacement.md#BKMK_mspp_adplacement_adx_inviteredemptions) one-to-many relationship for the [mspp_adplacement](mspp_adplacement.md) table/entity.

### <a name="BKMK_mspp_pollplacement_adx_inviteredemptions"></a> mspp_pollplacement_adx_inviteredemptions

**Added by**: Power Pages Apps Solution

See the [mspp_pollplacement_adx_inviteredemptions](mspp_pollplacement.md#BKMK_mspp_pollplacement_adx_inviteredemptions) one-to-many relationship for the [mspp_pollplacement](mspp_pollplacement.md) table/entity.
...
See the [mspp_publishingstatetransitionrule_adx_inviteredemptions](mspp_publishingstatetransitionrule.md#BKMK_mspp_publishingstatetransitionrule_adx_inviteredemptions) one-to-many relationship for the [mspp_publishingstatetransitionrule](mspp_publishingstatetransitionrule.md) table/entity.

### <a name="BKMK_mspp_redirect_adx_inviteredemptions"></a> mspp_redirect_adx_inviteredemptions

**Added by**: Power Pages Apps Solution

See the [mspp_redirect_adx_inviteredemptions](mspp_redirect.md#BKMK_mspp_redirect_adx_inviteredemptions) one-to-many relationship for the [mspp_redirect](mspp_redirect.md) table/entity.

### <a name="BKMK_mspp_shortcut_adx_inviteredemptions"></a> mspp_shortcut_adx_inviteredemptions

**Added by**: Power Pages Apps Solution

See the [mspp_shortcut_adx_inviteredemptions](mspp_shortcut.md#BKMK_mspp_shortcut_adx_inviteredemptions) one-to-many relationship for the [mspp_shortcut](mspp_shortcut.md) table/entity.

### <a name="BKMK_mspp_website_adx_inviteredemptions"></a> mspp_website_adx_inviteredemptions

**Added by**: Power Pages Apps Solution

See the [mspp_website_adx_inviteredemptions](mspp_website.md#BKMK_mspp_website_adx_inviteredemptions) one-to-many relationship for the [mspp_website](mspp_website.md) table/entity.

### See also

[Dataverse table/entity reference](../about-entity-reference.md)  
[Web API Reference](/dynamics365/customer-engagement/web-api/about)  
<xref href="Microsoft.Dynamics.CRM.adx_inviteredemption?text=adx_inviteredemption EntityType" />