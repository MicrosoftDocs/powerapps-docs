...
# PM Template (msdyn_pmtemplate) table/entity reference (Microsoft Dataverse)



## Messages

The following table lists the messages for the PM Template (msdyn_pmtemplate) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `Create`<br />Event: True |`POST` /msdyn_pmtemplates<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_pmtemplates<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_pmtemplates(*msdyn_pmtemplateid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the PM Template (msdyn_pmtemplate) table.
...
The following table lists selected properties for the PM Template (msdyn_pmtemplate) table.
...
|RequiredLevel|SystemRequired|
|Type|Boolean|
|GlobalChoiceName|`msdyn_pminferredtask_msdyn_isprivatetemplate`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_pmtemplate_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_pmtemplate_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_pmtemplate](businessunit.md#BKMK_business_unit_msdyn_pmtemplate)
...
One-To-Many Relationship: [systemuser lk_msdyn_pmtemplate_createdby](systemuser.md#BKMK_lk_msdyn_pmtemplate_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_pmtemplate_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_pmtemplate_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_pmtemplate_modifiedby](systemuser.md#BKMK_lk_msdyn_pmtemplate_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_pmtemplate_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_pmtemplate_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_pmtemplate](owner.md#BKMK_owner_msdyn_pmtemplate)
...
One-To-Many Relationship: [team team_msdyn_pmtemplate](team.md#BKMK_team_msdyn_pmtemplate)
...
One-To-Many Relationship: [systemuser user_msdyn_pmtemplate](systemuser.md#BKMK_user_msdyn_pmtemplate)
...
Many-To-One Relationship: [asyncoperation msdyn_pmtemplate_AsyncOperations](asyncoperation.md#BKMK_msdyn_pmtemplate_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_pmtemplate_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_pmtemplate_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_pmtemplate_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_pmtemplate_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_pmtemplate_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_pmtemplate_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_pmtemplate_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_pmtemplate_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_pmtemplate_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_pmtemplate_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_pmtemplate_ProcessSession](processsession.md#BKMK_msdyn_pmtemplate_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_pmtemplate_SyncErrors](syncerror.md#BKMK_msdyn_pmtemplate_SyncErrors)
