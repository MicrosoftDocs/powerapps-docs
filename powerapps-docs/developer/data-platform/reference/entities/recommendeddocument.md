...
Many-To-One Relationship: [deleteditemreference recommendeddocument_DeletedItemReferences](deleteditemreference.md#BKMK_recommendeddocument_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`recommendeddocument_DeletedItemReferences`|
|IsCustomizable|`True`|
