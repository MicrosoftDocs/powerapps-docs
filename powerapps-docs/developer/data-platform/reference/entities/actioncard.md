...
Many-To-One Relationship: [deleteditemreference actioncard_DeletedItemReferences](deleteditemreference.md#BKMK_actioncard_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`actioncard_DeletedItemReferences`|
|IsCustomizable|`True`|
