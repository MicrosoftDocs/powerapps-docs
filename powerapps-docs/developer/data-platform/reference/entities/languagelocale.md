...
Many-To-One Relationship: [deleteditemreference languagelocale_DeletedItemReferences](deleteditemreference.md#BKMK_languagelocale_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`languagelocale_DeletedItemReferences`|
|IsCustomizable|`True`|
