...
# makerfewshot table/entity reference (Microsoft Dataverse)
...
| `Create`<br />Event: True |`POST` /makerfewshots<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
...
| `Update`<br />Event: True |`PATCH` /makerfewshots(*makerfewshotid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /makerfewshots(*makerfewshotid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the makerfewshot table.
...
The following table lists selected properties for the makerfewshot table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`makerfewshot_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`makerfewshot_statuscode`|
...
One-To-Many Relationship: [systemuser lk_makerfewshot_createdby](systemuser.md#BKMK_lk_makerfewshot_createdby)
...
One-To-Many Relationship: [systemuser lk_makerfewshot_createdonbehalfby](systemuser.md#BKMK_lk_makerfewshot_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_makerfewshot_modifiedby](systemuser.md#BKMK_lk_makerfewshot_modifiedby)
...
One-To-Many Relationship: [systemuser lk_makerfewshot_modifiedonbehalfby](systemuser.md#BKMK_lk_makerfewshot_modifiedonbehalfby)
...
One-To-Many Relationship: [organization organization_makerfewshot](organization.md#BKMK_organization_makerfewshot)
...
Many-To-One Relationship: [asyncoperation makerfewshot_AsyncOperations](asyncoperation.md#BKMK_makerfewshot_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure makerfewshot_BulkDeleteFailures](bulkdeletefailure.md#BKMK_makerfewshot_BulkDeleteFailures)
...
Many-To-One Relationship: [deleteditemreference makerfewshot_DeletedItemReferences](deleteditemreference.md#BKMK_makerfewshot_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`makerfewshot_DeletedItemReferences`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_makerfewshot_MailboxTrackingFolders"></a> makerfewshot_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder makerfewshot_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_makerfewshot_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess makerfewshot_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_makerfewshot_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession makerfewshot_ProcessSession](processsession.md#BKMK_makerfewshot_ProcessSession)
...
Many-To-One Relationship: [syncerror makerfewshot_SyncErrors](syncerror.md#BKMK_makerfewshot_SyncErrors)
