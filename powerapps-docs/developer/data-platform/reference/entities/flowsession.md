...
|CancelDesktopFlowRun|<xref:Microsoft.Dynamics.CRM.CancelDesktopFlowRun?displayProperty=nameWithType />|Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
Same as the [flowevent_flowsession](flowevent.md#BKMK_flowevent_flowsession) many-to-one relationship for the [flowevent](flowevent.md) table/entity.
...
Same as the [flowsession_flowlog_parentobjectid](flowlog.md#BKMK_flowsession_flowlog_parentobjectid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
...
Same as the [flowsession_flowlog_flowsessionid](flowlog.md#BKMK_flowsession_flowlog_flowsessionid) many-to-one relationship for the [flowlog](flowlog.md) table/entity.
