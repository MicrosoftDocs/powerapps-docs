...
Many-To-One Relationship: [deleteditemreference personaldocumenttemplate_DeletedItemReferences](deleteditemreference.md#BKMK_personaldocumenttemplate_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`personaldocumenttemplate_DeletedItemReferences`|
|IsCustomizable|`True`|
