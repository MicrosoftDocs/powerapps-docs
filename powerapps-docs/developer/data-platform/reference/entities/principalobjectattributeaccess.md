...
See the [deploymentorchestration_PrincipalObjectAttributeAccesses](deploymentorchestration.md#BKMK_deploymentorchestration_PrincipalObjectAttributeAccesses) one-to-many relationship for the [deploymentorchestration](deploymentorchestration.md) table/entity.
