...
Many-To-One Relationship: [deleteditemreference sdkmessageprocessingstepsecureconfig_DeletedItemReferences](deleteditemreference.md#BKMK_sdkmessageprocessingstepsecureconfig_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`sdkmessageprocessingstepsecureconfig_DeletedItemReferences`|
|IsCustomizable|`True`|
