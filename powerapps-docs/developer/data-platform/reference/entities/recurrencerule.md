...
Many-To-One Relationship: [deleteditemreference recurrencerule_DeletedItemReferences](deleteditemreference.md#BKMK_recurrencerule_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`recurrencerule_DeletedItemReferences`|
|IsCustomizable|`True`|
