...
|-|-|-|
|Assign|PATCH /chats(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST /chats<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|CreateMultiple||<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
|Delete|DELETE /chats(*activityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref:Microsoft.Dynamics.CRM.GrantAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref:Microsoft.Dynamics.CRM.IsValidStateTransition?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref:Microsoft.Dynamics.CRM.ModifyAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET /chats(*activityid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET /chats<br />See [Query Data](/powerapps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH /chats(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH /chats(*activityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
### <a name="BKMK_ModifiedInTeamsOn"></a> ModifiedInTeamsOn
...
- [LinkedByName](#BKMK_LinkedByName)
- [LinkedByYomiName](#BKMK_LinkedByYomiName)
...
- [UnLinkedByName](#BKMK_UnLinkedByName)
- [UnLinkedByYomiName](#BKMK_UnLinkedByYomiName)
...
### <a name="BKMK_LinkedBy"></a> LinkedBy
...
### <a name="BKMK_LinkedByName"></a> LinkedByName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|linkedbyname|
|MaxLength|200|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_LinkedByYomiName"></a> LinkedByYomiName
...
### <a name="BKMK_UnLinkedByName"></a> UnLinkedByName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|unlinkedbyname|
|MaxLength|200|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_UnLinkedByYomiName"></a> UnLinkedByYomiName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|unlinkedbyyominame|
|MaxLength|200|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_UnLinkedOn"></a> UnLinkedOn
...
Same as the [chat_activity_parties](activityparty.md#BKMK_chat_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) table/entity.
...
Same as the [chat_ActionCards](actioncard.md#BKMK_chat_ActionCards) many-to-one relationship for the [actioncard](actioncard.md) table/entity.
...
Same as the [chat_SyncErrors](syncerror.md#BKMK_chat_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) table/entity.
...
Same as the [chat_AsyncOperations](asyncoperation.md#BKMK_chat_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) table/entity.
...
Same as the [chat_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_chat_MailboxTrackingFolders) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) table/entity.
...
Same as the [chat_ProcessSession](processsession.md#BKMK_chat_ProcessSession) many-to-one relationship for the [processsession](processsession.md) table/entity.
...
Same as the [chat_BulkDeleteFailures](bulkdeletefailure.md#BKMK_chat_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) table/entity.
...
Same as the [chat_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_chat_PrincipalObjectAttributeAccesses) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) table/entity.
...
Same as the [chat_QueueItems](queueitem.md#BKMK_chat_QueueItems) many-to-one relationship for the [queueitem](queueitem.md) table/entity.
...
Same as the [chat_Annotations](annotation.md#BKMK_chat_Annotations) many-to-one relationship for the [annotation](annotation.md) table/entity.
...
See the [interactionforemail_chats](interactionforemail.md#BKMK_interactionforemail_chats) one-to-many relationship for the [interactionforemail](interactionforemail.md) table/entity.

### <a name="BKMK_knowledgebaserecord_chats"></a> knowledgebaserecord_chats

**Added by**: System Solution Solution

See the [knowledgebaserecord_chats](knowledgebaserecord.md#BKMK_knowledgebaserecord_chats) one-to-many relationship for the [knowledgebaserecord](knowledgebaserecord.md) table/entity.

### <a name="BKMK_account_chats"></a> account_chats

**Added by**: System Solution Solution

See the [account_chats](account.md#BKMK_account_chats) one-to-many relationship for the [account](account.md) table/entity.

### <a name="BKMK_chat_systemuser_createdby"></a> chat_systemuser_createdby

**Added by**: System Solution Solution

See the [chat_systemuser_createdby](systemuser.md#BKMK_chat_systemuser_createdby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_contact_chats"></a> contact_chats

**Added by**: System Solution Solution

See the [contact_chats](contact.md#BKMK_contact_chats) one-to-many relationship for the [contact](contact.md) table/entity.

### <a name="BKMK_chat_mailbox_sendermailboxid"></a> chat_mailbox_sendermailboxid

**Added by**: System Solution Solution

See the [chat_mailbox_sendermailboxid](mailbox.md#BKMK_chat_mailbox_sendermailboxid) one-to-many relationship for the [mailbox](mailbox.md) table/entity.

### <a name="BKMK_chat_transactioncurrency_transactioncurrencyid"></a> chat_transactioncurrency_transactioncurrencyid

**Added by**: System Solution Solution

See the [chat_transactioncurrency_transactioncurrencyid](transactioncurrency.md#BKMK_chat_transactioncurrency_transactioncurrencyid) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) table/entity.

### <a name="BKMK_chat_systemuser_owninguser"></a> chat_systemuser_owninguser

**Added by**: System Solution Solution

See the [chat_systemuser_owninguser](systemuser.md#BKMK_chat_systemuser_owninguser) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_chat_sla_slaid"></a> chat_sla_slaid

**Added by**: System Solution Solution

See the [chat_sla_slaid](sla.md#BKMK_chat_sla_slaid) one-to-many relationship for the [sla](sla.md) table/entity.

### <a name="BKMK_chat_businessunit_owningbusinessunit"></a> chat_businessunit_owningbusinessunit

**Added by**: System Solution Solution

See the [chat_businessunit_owningbusinessunit](businessunit.md#BKMK_chat_businessunit_owningbusinessunit) one-to-many relationship for the [businessunit](businessunit.md) table/entity.

### <a name="BKMK_knowledgearticle_chats"></a> knowledgearticle_chats

**Added by**: System Solution Solution

See the [knowledgearticle_chats](knowledgearticle.md#BKMK_knowledgearticle_chats) one-to-many relationship for the [knowledgearticle](knowledgearticle.md) table/entity.

### <a name="BKMK_chat_systemuser_modifiedonbehalfby"></a> chat_systemuser_modifiedonbehalfby

**Added by**: System Solution Solution

See the [chat_systemuser_modifiedonbehalfby](systemuser.md#BKMK_chat_systemuser_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_chat_systemuser_createdonbehalfby"></a> chat_systemuser_createdonbehalfby

**Added by**: System Solution Solution

See the [chat_systemuser_createdonbehalfby](systemuser.md#BKMK_chat_systemuser_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_chat_systemuser_modifiedby"></a> chat_systemuser_modifiedby

**Added by**: System Solution Solution

See the [chat_systemuser_modifiedby](systemuser.md#BKMK_chat_systemuser_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_chat_team_owningteam"></a> chat_team_owningteam

**Added by**: System Solution Solution

See the [chat_team_owningteam](team.md#BKMK_chat_team_owningteam) one-to-many relationship for the [team](team.md) table/entity.

### <a name="BKMK_chat_sla_slainvokedid"></a> chat_sla_slainvokedid

**Added by**: System Solution Solution

See the [chat_sla_slainvokedid](sla.md#BKMK_chat_sla_slainvokedid) one-to-many relationship for the [sla](sla.md) table/entity.

### <a name="BKMK_activity_pointer_chat"></a> activity_pointer_chat

**Added by**: System Solution Solution

See the [activity_pointer_chat](activitypointer.md#BKMK_activity_pointer_chat) one-to-many relationship for the [activitypointer](activitypointer.md) table/entity.

### <a name="BKMK_teams_chat_activity_linkrecord_systemUser"></a> teams_chat_activity_linkrecord_systemUser

**Added by**: System Solution Solution

See the [teams_chat_activity_linkrecord_systemUser](systemuser.md#BKMK_teams_chat_activity_linkrecord_systemUser) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_teams_chat_activity_unlinkrecord_systemUser"></a> teams_chat_activity_unlinkrecord_systemUser

**Added by**: System Solution Solution

See the [teams_chat_activity_unlinkrecord_systemUser](systemuser.md#BKMK_teams_chat_activity_unlinkrecord_systemUser) one-to-many relationship for the [systemuser](systemuser.md) table/entity.

### <a name="BKMK_adx_invitation_chats"></a> adx_invitation_chats

**Added by**: Power Pages Runtime Core Solution

See the [adx_invitation_chats](adx_invitation.md#BKMK_adx_invitation_chats) one-to-many relationship for the [adx_invitation](adx_invitation.md) table/entity.

### <a name="BKMK_mspp_adplacement_chats"></a> mspp_adplacement_chats

**Added by**: Power Pages Apps Solution

See the [mspp_adplacement_chats](mspp_adplacement.md#BKMK_mspp_adplacement_chats) one-to-many relationship for the [mspp_adplacement](mspp_adplacement.md) table/entity.

### <a name="BKMK_mspp_pollplacement_chats"></a> mspp_pollplacement_chats

**Added by**: Power Pages Apps Solution

See the [mspp_pollplacement_chats](mspp_pollplacement.md#BKMK_mspp_pollplacement_chats) one-to-many relationship for the [mspp_pollplacement](mspp_pollplacement.md) table/entity.

### <a name="BKMK_mspp_publishingstatetransitionrule_chats"></a> mspp_publishingstatetransitionrule_chats

**Added by**: Power Pages Apps Solution

See the [mspp_publishingstatetransitionrule_chats](mspp_publishingstatetransitionrule.md#BKMK_mspp_publishingstatetransitionrule_chats) one-to-many relationship for the [mspp_publishingstatetransitionrule](mspp_publishingstatetransitionrule.md) table/entity.

### <a name="BKMK_mspp_redirect_chats"></a> mspp_redirect_chats

**Added by**: Power Pages Apps Solution

See the [mspp_redirect_chats](mspp_redirect.md#BKMK_mspp_redirect_chats) one-to-many relationship for the [mspp_redirect](mspp_redirect.md) table/entity.

### <a name="BKMK_mspp_shortcut_chats"></a> mspp_shortcut_chats

**Added by**: Power Pages Apps Solution

See the [mspp_shortcut_chats](mspp_shortcut.md#BKMK_mspp_shortcut_chats) one-to-many relationship for the [mspp_shortcut](mspp_shortcut.md) table/entity.

### <a name="BKMK_mspp_website_chats"></a> mspp_website_chats

**Added by**: Power Pages Apps Solution

See the [mspp_website_chats](mspp_website.md#BKMK_mspp_website_chats) one-to-many relationship for the [mspp_website](mspp_website.md) table/entity.

### See also

[Dataverse table/entity reference](../about-entity-reference.md)  
[Web API Reference](/dynamics365/customer-engagement/web-api/about)  
<xref href="Microsoft.Dynamics.CRM.chat?text=chat EntityType" />