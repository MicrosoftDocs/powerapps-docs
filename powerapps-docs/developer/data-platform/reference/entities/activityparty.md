...
| ---- | ----- |----- |
| `AppendRelatedParty`<br />Event: True |<xref:Microsoft.Dynamics.CRM.AppendRelatedParty?displayProperty=nameWithType /> |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
...
Many-To-One Relationship: [deleteditemreference activityparty_DeletedItemReferences](deleteditemreference.md#BKMK_activityparty_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`activityparty_DeletedItemReferences`|
|IsCustomizable|`True`|
