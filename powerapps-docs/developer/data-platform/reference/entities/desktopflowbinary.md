---
title: "Desktop Flow Binary (desktopflowbinary) table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the Desktop Flow Binary (desktopflowbinary) table/entity with Microsoft Dataverse."
...
# Desktop Flow Binary (desktopflowbinary) table/entity reference (Microsoft Dataverse)



## Messages

The following table lists the messages for the Desktop Flow Binary (desktopflowbinary) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /desktopflowbinaries(*desktopflowbinaryid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `Create`<br />Event: True |`POST` /desktopflowbinaries<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /desktopflowbinaries(*desktopflowbinaryid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /desktopflowbinaries(*desktopflowbinaryid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
...
| `Upsert`<br />Event: False |`PATCH` /desktopflowbinaries(*desktopflowbinaryid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|

## Properties

The following table lists selected properties for the Desktop Flow Binary (desktopflowbinary) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`desktopflowbinary_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`desktopflowbinary_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_desktopflowbinary](businessunit.md#BKMK_business_unit_desktopflowbinary)
...
One-To-Many Relationship: [desktopflowmodule dfm_desktopflowbinary_DFM](desktopflowmodule.md#BKMK_dfm_desktopflowbinary_DFM)
...
|ReferencingEntityNavigationPropertyName|`desktopflowmodule`|
|IsHierarchical||
...
One-To-Many Relationship: [fileattachment FileAttachment_desktopflowbinary_Data](fileattachment.md#BKMK_FileAttachment_desktopflowbinary_Data)
...
One-To-Many Relationship: [systemuser lk_desktopflowbinary_createdby](systemuser.md#BKMK_lk_desktopflowbinary_createdby)
...
One-To-Many Relationship: [systemuser lk_desktopflowbinary_createdonbehalfby](systemuser.md#BKMK_lk_desktopflowbinary_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_desktopflowbinary_modifiedby](systemuser.md#BKMK_lk_desktopflowbinary_modifiedby)
...
One-To-Many Relationship: [systemuser lk_desktopflowbinary_modifiedonbehalfby](systemuser.md#BKMK_lk_desktopflowbinary_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_desktopflowbinary](owner.md#BKMK_owner_desktopflowbinary)
...
One-To-Many Relationship: [team team_desktopflowbinary](team.md#BKMK_team_desktopflowbinary)
...
One-To-Many Relationship: [systemuser user_desktopflowbinary](systemuser.md#BKMK_user_desktopflowbinary)
...
One-To-Many Relationship: [workflow workflow_desktopflowbinary_Process](workflow.md#BKMK_workflow_desktopflowbinary_Process)
...
Many-To-One Relationship: [asyncoperation desktopflowbinary_AsyncOperations](asyncoperation.md#BKMK_desktopflowbinary_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure desktopflowbinary_BulkDeleteFailures](bulkdeletefailure.md#BKMK_desktopflowbinary_BulkDeleteFailures)
...
Many-To-One Relationship: [fileattachment desktopflowbinary_FileAttachments](fileattachment.md#BKMK_desktopflowbinary_FileAttachments)

|Property|Value|
|---|---|
|ReferencingEntity|`fileattachment`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`desktopflowbinary_FileAttachments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_desktopflowbinary_MailboxTrackingFolders"></a> desktopflowbinary_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder desktopflowbinary_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_desktopflowbinary_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess desktopflowbinary_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_desktopflowbinary_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession desktopflowbinary_ProcessSession](processsession.md#BKMK_desktopflowbinary_ProcessSession)
...
Many-To-One Relationship: [syncerror desktopflowbinary_SyncErrors](syncerror.md#BKMK_desktopflowbinary_SyncErrors)
...
<xref:Microsoft.Dynamics.CRM.desktopflowbinary?displayProperty=fullName>
