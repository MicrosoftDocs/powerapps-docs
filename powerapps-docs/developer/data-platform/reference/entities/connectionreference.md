...
|PvaShareConnection||Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|-----|-----|--------|
|0|Prompt on import|Prompt to provide a connection for this reference during import|
|1|Skip|Skip all prompting behavior. Used for Invoker based Connection References|
...
Same as the [msdyn_dfcr_cr_connect](msdyn_dataflowconnectionreference.md#BKMK_msdyn_dfcr_cr_connect) many-to-one relationship for the [msdyn_dataflowconnectionreference](msdyn_dataflowconnectionreference.md) table/entity.
