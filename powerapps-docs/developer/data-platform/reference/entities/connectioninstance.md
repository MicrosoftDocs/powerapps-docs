...
|ConfirmConsentCode|<xref:Microsoft.Dynamics.CRM.ConfirmConsentCode?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = ConfirmConsentCode|
...
|GetConsentLink|<xref:Microsoft.Dynamics.CRM.GetConsentLink?displayProperty=nameWithType />|Use <xref:Microsoft.Xrm.Sdk.OrganizationRequest><br/>where <xref:Microsoft.Xrm.Sdk.OrganizationRequest.RequestName> = GetConsentLink|
