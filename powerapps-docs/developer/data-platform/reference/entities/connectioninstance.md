...
|ConfirmConsentCode|<xref href="Microsoft.Dynamics.CRM.ConfirmConsentCode?text=ConfirmConsentCode Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|GetConsentLink|<xref href="Microsoft.Dynamics.CRM.GetConsentLink?text=GetConsentLink Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
