...
Many-To-One Relationship: [deleteditemreference timezonerule_DeletedItemReferences](deleteditemreference.md#BKMK_timezonerule_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`timezonerule_DeletedItemReferences`|
|IsCustomizable|`True`|
