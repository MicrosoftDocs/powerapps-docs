...
Many-To-One Relationship: [deleteditemreference plugintypestatistic_DeletedItemReferences](deleteditemreference.md#BKMK_plugintypestatistic_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`plugintypestatistic_DeletedItemReferences`|
|IsCustomizable|`True`|
