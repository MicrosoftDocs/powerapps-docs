...
Many-To-One Relationship: [deleteditemreference subscriptionmanuallytrackedobject_DeletedItemReferences](deleteditemreference.md#BKMK_subscriptionmanuallytrackedobject_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`subscriptionmanuallytrackedobject_DeletedItemReferences`|
|IsCustomizable|`True`|
