...
Many-To-One Relationship: [deleteditemreference aciviewmapper_DeletedItemReferences](deleteditemreference.md#BKMK_aciviewmapper_DeletedItemReferences)

|Property|Value|
|---|---|
|ReferencingEntity|`deleteditemreference`|
|ReferencingAttribute|`deletedobject`|
|ReferencedEntityNavigationPropertyName|`aciviewmapper_DeletedItemReferences`|
|IsCustomizable|`True`|
