...
The following information describes selected columns for the three tables that contain the data for a Custom API. You should review this as you plan the behavior for your Custom API.
