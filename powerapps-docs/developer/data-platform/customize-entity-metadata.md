...
|Option|Description|  
|------------|-----------------|  
|**Create as custom activity**|You can create an table that is an activity by setting the `IsActivity` property when using the organization service or Web API respectively. For more information, see [Custom Activities in Dynamics 365](custom-activities.md).|  
...
## Enable table capabilities  
 ...
 The following lists table capabilities. You can set these capabilities when you create an table or you can enable them later. Once enabled, these capabilities cannot be disabled.  
...
|                            **Edit the entity Description**                             |                                                                                                         The managed property `IsRenameable` prevents the table description from being changed in the application. You can still programmatically change the labels by updating the `Description` property.                                                                                                         |
