...
## Create an elastic table row

## Retrieve an elastic table row

## Update an elastic table row

## Upsert an elastic table row

## Delete an elastic table row

## Query elastic table rows