...
More information: [Create and update table definitions using the Web API > Create attributes](https://msdn.microsoft.com/library/mt593078.aspx#Anchor_3).
...
[Customize metadata](customize-entity-metadata.md) 
