...
|[solution](#solution)|Commands for working with [Microsoft Dataverse solution projects](/powerapps/maker/common-data-service/solutions-overview).|
...
Commands for working with [Dataverse solution projects](/powerapps/maker/common-data-service/solutions-overview). It has the following parameters:
