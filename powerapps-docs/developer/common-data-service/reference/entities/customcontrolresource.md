---
title: "CustomControlResource Entity Reference (Common Data Service for Apps)| Microsoft Docs"
...
**DisplayName**: Custom Control Resource<br />
**DisplayCollectionName**: Custom Control Resources<br />
**SchemaName**: CustomControlResource<br />
**CollectionSchemaName**: CustomControlResources<br />
**LogicalName**: customcontrolresource<br />
**LogicalCollectionName**: customcontrolresources<br />
**EntitySetName**: customcontrolresources<br />
**PrimaryIdAttribute**: customcontrolresourceid<br />
...
**Description**: Unique identifier of the custom control.<br />
...
**Description**: Unique identifier of the Custom Control Resource.<br />
**DisplayName**: Custom Control Resource Id<br />
**LogicalName**: customcontrolresourceid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Name of the custom control resource.<br />
**DisplayName**: Name<br />
**LogicalName**: name<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**DisplayName**: Custom Control Resource Version<br />
...
**Description**: For internal use only.<br />
**DisplayName**: Custom Control Resource Version Requirement<br />
**LogicalName**: versionrequirement<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: For internal use only.<br />
**DisplayName**: <br />
**LogicalName**: customcontrolresourceidunique<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Uniqueidentifier<br />
...
**Description**: Version number of the Custom Control Resource.<br />
