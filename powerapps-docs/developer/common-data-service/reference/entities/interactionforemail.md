---
title: "InteractionForEmail Entity Reference (Common Data Service for Apps)| Microsoft Docs"
...
**Description**: For internal use only.<br />
**DisplayName**: Interaction party id.<br />
**LogicalName**: interactionpartyid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Uniqueidentifier<br />
...
**Description**: For internal use only<br />
**DisplayName**: Interaction party type code.<br />
**LogicalName**: interactionpartytypecode<br />
**IsValidForForm**: False<br />
