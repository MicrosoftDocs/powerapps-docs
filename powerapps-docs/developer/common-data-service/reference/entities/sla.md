---
title: "SLA table reference (Common Data Service)| MicrosoftDocs"
...
|Property|Value|
|--------|-----|
|Description|Enter the user or team who owns the SLA. This field is updated every time the item assignment is changed.|
|DisplayName|Owner|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|ownerid|
