---
title: "ACIViewMapper Entity Reference (Common Data Service)| Microsoft Docs"
...
**DisplayName**: ACIViewMapper<br />
**DisplayCollectionName**: ACIViewMappers<br />
**SchemaName**: ACIViewMapper<br />
**CollectionSchemaName**: aciviewmappers<br />
**LogicalName**: aciviewmapper<br />
**LogicalCollectionName**: aciviewmappers<br />
**EntitySetName**: aciviewmappers<br />
**PrimaryIdAttribute**: aciviewmapperid<br />
...
**DisplayName**: ACIViewMapper<br />
**LogicalName**: aciviewmapperid<br />
...
**Description**: End point of web application<br />
**DisplayName**: Web Application EndPoint<br />
**LogicalName**: webapplicationendpoint<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Status of the ACIViewMapper<br />
