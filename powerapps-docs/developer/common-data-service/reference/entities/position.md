---
title: "Position Entity Reference (Common Data Service for Apps)| Microsoft Docs"
...
**DisplayCollectionName**: Positions<br />
**SchemaName**: Position<br />
**CollectionSchemaName**: Positions<br />
**LogicalName**: position<br />
**LogicalCollectionName**: positions<br />
**EntitySetName**: positions<br />
**PrimaryIdAttribute**: positionid<br />
...
**Description**: The description of the position.<br />
...
**Description**: The name of the position.<br />
**DisplayName**: Name<br />
**LogicalName**: name<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**Description**: Parent position.<br />
**DisplayName**: Parent Position<br />
**LogicalName**: parentpositionid<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Lookup<br />
...
**Description**: Unique identifier for position entity instances<br />
**DisplayName**: Position<br />
...
**Description**: Status of the Position<br />
...
**Description**: Reason for the status of the Position<br />
...
**Description**: Unique identifier of the currency associated with the position.<br />
...
**Description**: Exchange rate for the currency associated with the position with respect to the base currency.<br />
...
**Description**: <br />
**DisplayName**: <br />
**LogicalName**: parentpositionidname<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**ReferencedEntityNavigationPropertyName**: position_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: position_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: positionid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: position_users<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: parentpositionid<br />
**IsHierarchical**: True<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: position_parent_position<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: Position_SyncErrors<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: position_connection2<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: position_principalobjectattributeaccess<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: position_connection1<br />
**AssociatedMenuConfiguration**:
