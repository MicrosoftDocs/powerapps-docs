...
Custom APIs offer a new code-first way to define messages that you can add to CDS web services. Conceptually, Custom APIs are an extension to Workflow Custom Actions that have been available to create custom messages without code.

Workflow Custom Action s will continue to provide a no-code way to declaratively define synchronous business logic. Custom APIs provide a capabilities specifically for developers to define their logic in code. For a full comparison of Workflow Custom Action and Custom API, see [Compare Workflow Custom Action and Custom API](custom-actions.md#compare-workflow-custom-action-and-custom-api).
...
- By manually entering data in available forms.  More information: TODO Create a Custom API using the UI in solution explorer
...
|**Status Reason**<br />`statuscode`|Status|Reason for the status of the Custom API<ul> <li>Value: 1 Label: Active </li> <li>Value: 2 Label: Inactive</li> </ul>|
|**Status**<br />`statecode`|State|Status of the Custom API<ul> <li>Value: 0 Label: Active </li> <li>Value: 1 Label: Inactive</li> </ul>|
...
|**Owner** <br />`OwnerId`|Owner|A reference to the user or team that owns the API.|
|**Status Reason**<br />`statuscode`|Status|Reason for the status of the Custom API Request Parameter.<ul> <li>Value: 1 Label: Active </li> <li>Value: 2 Label: Inactive</li> </ul>|
|**Status**<br />`statecode`|State|Status of the Custom API Request Parameter.<ul> <li>Value: 0 Label: Active </li> <li>Value: 1 Label: Inactive</li> </ul>|
...
|**Owner** <br />`OwnerId`|Owner|A reference to the user or team that owns the API.|
|**Status Reason**<br />`statuscode`|Status|Reason for the status of the Custom API response property .<ul> <li>Value: 1 Label: Active </li> <li>Value: 2 Label: Inactive</li> </ul>|
|**Status**<br />`statecode`|State|Status of the Custom API Response Property .<ul> <li>Value: 0 Label: Active </li> <li>Value: 1 Label: Inactive</li> </ul>|
