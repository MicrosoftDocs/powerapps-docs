...
>[!NOTE]
>EntitySetName is automatically generated by changing the EntityName to the plural of that name. Example: EntityName: Car EntitySetName: Cars. When manually creating a new entity the EntitySetName can be changed. System created EntitySetNames will always be the plural of the EntityName and these cannot be changed through the client interface or APIs. This includes system entities as well as entitles created for many to many relationship intersects.
