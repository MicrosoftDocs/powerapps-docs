---
title: "Server-side synchronization entities (Common Data Service for Apps) | Microsoft Docs"
description: "Server-side synchronization provides an interface between Common Data Service for Apps and one or more Exchange servers or POP3 servers for incoming email, and one or more SMTP or Exchange servers for outgoing email."
ms.custom: ""
ms.date: 02/21/2019
ms.reviewer: "kvivek"
