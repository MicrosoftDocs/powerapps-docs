...
When you share a record with another user using <xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>, or modify access using <xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>, you must indicate what access rights you want to
...
[ShareToPreviousOwnerOnAssign](reference/entities/organization#BKMK_ShareToPreviousOwnerOnAssign) attribute controls this setting.
