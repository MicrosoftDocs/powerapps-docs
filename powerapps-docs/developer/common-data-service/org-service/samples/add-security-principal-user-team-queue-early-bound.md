---
title: "Sample: Add a security principal (user or team) to a queue  (Common Data Service for Apps) | Microsoft Docs" # Intent and product brand in a unique string of 43-59 chars including spaces
...
3. The `QueryExpression` retrieves the defaulr business unit for the creation of the team and role.
