---
title: " Serialize and deserialize table instances (Common Data Service) | Microsoft Docs" # Intent and product brand in a unique string of 43-59 chars including spaces
...
# Serialize and deserialize an table instance 
...
1. The `DataContractSerializer` method serializes the contact rows into XML and write it to the hard drive. 
