---
title: "Sample: Create a reciprocal connection role(Common Data Service) | Microsoft Docs" # Intent and product brand in a unique string of 43-59 chars including spaces
...
3. The `ConnectionRoleObjectTypeCode` message creates the connection role object type code row for account.
