---
title: "Sample: Retrieve column sharing rows (Common Data Service) | Microsoft Docs" # Intent and product brand in a unique string of 43-59 chars including spaces
description: "This sample shows how to retrieve the column sharing rows for an table." # 115-145 characters including spaces. This abstract displays in the search result.
ms.custom: ""
ms.date: 10/31/2018
ms.reviewer: "pehecke"
...
search.app: 
  ...
  - D365CE
---
# Sample: Retrieve column sharing rows

[!INCLUDE[cc-data-platform-banner](../../../../includes/cc-data-platform-banner.md)]

<!-- https://docs.microsoft.com/dynamics365/customer-engagement/developer/sample-retrieve-field-sharing-records -->

This sample shows how to retrieve the `PrincipalObjectAttributeAccess` (column sharing) rows for an table. You can download the sample from [here](https://github.com/Microsoft/PowerApps-Samples/tree/master/cds/orgsvc/C%23/RetrieveFieldSharing).
...
The `PrincipleObjectAttributeAccess` message is intended to be used in a scenario where it retrieves the column sharing rows for an table.
