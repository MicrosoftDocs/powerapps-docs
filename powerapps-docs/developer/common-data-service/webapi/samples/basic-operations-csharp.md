...
|SampleHelper.cs|Contains the helper code to assist perform common tasks, such as application configuration, authentication and `HTTP` response error handling.|  
