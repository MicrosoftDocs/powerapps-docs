...
import {IInputs, IOutputs} from "./generated/ManifestTypes";
    ...
    export class TSControlStateAPI implements ControlFramework.StandardControl<IInputs, IOutputs> 
    {
	    ...
	    */
		 ...
		 */
        public init(context: ControlFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ControlFramework.Dictionary, container:HTMLDivElement): void
        {
