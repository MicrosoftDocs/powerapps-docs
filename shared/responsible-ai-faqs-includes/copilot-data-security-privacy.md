...
| Dynamics 365 Customer Insights (Data) | [Get answers to questions about capabilities from Copilot (preview)](https://learn.microsoft.com/en-us/dynamics365/customer-insights/data/help-pane-copilot)  | No |  CI-Data has its own flag for all its Copilot features by AOAI, described in [Give consent to use Copilot in Customer Insights - Data](/dynamics365/customer-insights/data/copilot-global-consent)  |
